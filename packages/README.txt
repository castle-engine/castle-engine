...
a single Lazarus package file?
  ...
  - For deprecated units (when you use "deprecated" as "unit Xxx;",
    like ../src/audio/castlesoundallocator.pas):
    also set "Add to Uses Clause" to false.
    Otherwise, compiling package makes warnings about the deprecated units.
