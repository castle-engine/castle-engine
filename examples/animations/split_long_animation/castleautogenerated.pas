...
initialization
  ApplicationProperties.ApplicationName := 'split_long_animation';
  ApplicationProperties.Caption := 'Split long animation into a number of smaller logical animations (subanimations)';
