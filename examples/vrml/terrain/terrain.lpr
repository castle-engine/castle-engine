  ...
  begin
    ...
    try
      ...
      begin
        ...
        Shader.AddCustomInitializeOnly(TSFNode.Create(Shader, 'tex_sand', [], TexSand));
        Shader.AddCustomInitializeOnly(TSFNode.Create(Shader, 'tex_bread', [], TexBread));
        Shader.AddCustomInitializeOnly(TSFNode.Create(Shader, 'tex_rock', [], TexRock));
        Shader.AddCustomInitializeOnly(TSFFloat.Create(Shader, 'z0', 0.8));
        Shader.AddCustomInitializeOnly(TSFFloat.Create(Shader, 'z1', 1.0));
        Shader.AddCustomInitializeOnly(TSFFloat.Create(Shader, 'z2', 1.2));
        Shader.AddCustomInitializeOnly(TSFFloat.Create(Shader, 'z3', 1.5));
        Shader.AddCustomInitializeOnly(TSFFloat.Create(Shader, 'color_scale', 0.2));
        Shader.AddCustomInitializeOnly(TSFFloat.Create(Shader, 'tex_scale', 0.8));
      ...
      SaveVRMLClassic(Root, FileName, 'Generated by terrain demo');
