...
// program physics_3d_third_person_standalone;
...
uses
  ...
  {$endif}
  CastleAutoGenerated, CastleWindow, GameInitialize, GameViewMain, SimplestFpsPlayerMovement, SimpleFpsPlayerMovementWithRotation, DirectRotateTransformByKeys, RotateRigidBody, HeadBobbing, FpsCrouch, RotateCamera, ModularMovement, StairsSupportByColliderCapsuleRadius, FpsFlySupport, FpsWalkSupport;
