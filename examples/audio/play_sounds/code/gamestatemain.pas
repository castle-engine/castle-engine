...
begin
  ...
  ButtonStop.OnClick := {$ifdef CASTLE_OBJFPC}@{$endif}ClickStop;
...
procedure TStateMain.Start;
  ...
  begin
    ...
    Button.OnClick := {$ifdef CASTLE_OBJFPC}@{$endif}ClickPlayBuffer;
...
begin
  ...
  ButtonExit.OnClick := {$ifdef CASTLE_OBJFPC}@{$endif}ClickExit;
...
begin
  ...
  PlayingSound.OnStop := {$ifdef CASTLE_OBJFPC}@{$endif}PlayingSoundStop;
