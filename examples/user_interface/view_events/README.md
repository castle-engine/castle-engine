...
- Or use [Delphi](https://www.embarcadero.com/products/Delphi). Open in Delphi `view_events_standalone.dproj` file and compile / run from Delphi. See [CGE and Delphi](https://castle-engine.io/delphi) documentation for details.
