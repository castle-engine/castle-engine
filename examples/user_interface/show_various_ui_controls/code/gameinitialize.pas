...
begin
  ...
  Button.OnClick := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.ButtonClick;
  Button.OnInternalMouseEnter := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.MouseEnter;
  Button.OnInternalMouseLeave := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.MouseLeave;
  ...
  Image2.OnInternalMouseEnter := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.MouseEnter;
  Image2.OnInternalMouseLeave := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.MouseLeave;
  ...
  SliderRotation.OnChange := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.RotationChange;

  ButtonDemo := TCastleButton.Create(Window);
  ButtonDemo.Caption := 'Button inside an on-screen menu';
  ButtonDemo.OnClick := {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.ButtonDemoClick;

  OnScreenMenu := TCastleOnScreenMenu.Create(Window);
  OnScreenMenu.Add('Clickable item', {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.ClickableItemClick);
  OnScreenMenu.Add('Another clickable item', {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.ClickableItemClick);
  ...
  OnScreenMenu.Add('UI Scale x2 (UIScaling := usExplicitScale, UIExplicitScale := 2.0)',
    {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.UIScalingExplicitTwiceClick);
  OnScreenMenu.Add('UI Scale /2 (UIScaling := usExplicitScale, UIExplicitScale := 0.5)',
    {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.UIScalingExplicitHalfClick);
  OnScreenMenu.Add('Do not Scale UI (UIScaling := usExplicitScale, UIExplicitScale := 1.0)',
    {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.UIScalingExplicitNormalClick);
  OnScreenMenu.Add('UI Scale adjust to window size (usEncloseReferenceSize);',
    {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.UIScalingEncloseReferenceClick);
  OnScreenMenu.Add('UI Scale adjust to window size (usFitReferenceSize);',
    {$ifdef CASTLE_OBJFPC}@{$endif}TEventsHandler{$ifdef FPC}(nil){$endif}.UIScalingFitReferenceClick);
