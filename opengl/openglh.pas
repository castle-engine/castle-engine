...
begin
 ...
 begin
  ...
  ProcVarCast(glAccum) := GLLibrary.Symbol('glAccum');
  ProcVarCast(glAlphaFunc) := GLLibrary.Symbol('glAlphaFunc');
  ProcVarCast(glAreTexturesResident) := GLLibrary.Symbol('glAreTexturesResident');
  ProcVarCast(glArrayElement) := GLLibrary.Symbol('glArrayElement');
  ProcVarCast(glBegin) := GLLibrary.Symbol('glBegin');
  ProcVarCast(glBindTexture) := GLLibrary.Symbol('glBindTexture');
  ProcVarCast(glBitmap) := GLLibrary.Symbol('glBitmap');
  ProcVarCast(glBlendFunc) := GLLibrary.Symbol('glBlendFunc');
  ProcVarCast(glCallList) := GLLibrary.Symbol('glCallList');
  ProcVarCast(glCallLists) := GLLibrary.Symbol('glCallLists');
  ProcVarCast(glClear) := GLLibrary.Symbol('glClear');
  ProcVarCast(glClearAccum) := GLLibrary.Symbol('glClearAccum');
  ProcVarCast(glClearColor) := GLLibrary.Symbol('glClearColor');
  ProcVarCast(glClearDepth) := GLLibrary.Symbol('glClearDepth');
  ProcVarCast(glClearIndex) := GLLibrary.Symbol('glClearIndex');
  ProcVarCast(glClearStencil) := GLLibrary.Symbol('glClearStencil');
  ProcVarCast(glClipPlane) := GLLibrary.Symbol('glClipPlane');
  ProcVarCast(glColor3b) := GLLibrary.Symbol('glColor3b');
  ProcVarCast(glColor3bv) := GLLibrary.Symbol('glColor3bv');
  ProcVarCast(glColor3d) := GLLibrary.Symbol('glColor3d');
  ProcVarCast(glColor3dv) := GLLibrary.Symbol('glColor3dv');
  ProcVarCast(glColor3f) := GLLibrary.Symbol('glColor3f');
  ProcVarCast(glColor3fv) := GLLibrary.Symbol('glColor3fv');
  ProcVarCast(glColor3i) := GLLibrary.Symbol('glColor3i');
  ProcVarCast(glColor3iv) := GLLibrary.Symbol('glColor3iv');
  ProcVarCast(glColor3s) := GLLibrary.Symbol('glColor3s');
  ProcVarCast(glColor3sv) := GLLibrary.Symbol('glColor3sv');
  ProcVarCast(glColor3ub) := GLLibrary.Symbol('glColor3ub');
  ProcVarCast(glColor3ubv) := GLLibrary.Symbol('glColor3ubv');
  ProcVarCast(glColor3ui) := GLLibrary.Symbol('glColor3ui');
  ProcVarCast(glColor3uiv) := GLLibrary.Symbol('glColor3uiv');
  ProcVarCast(glColor3us) := GLLibrary.Symbol('glColor3us');
  ProcVarCast(glColor3usv) := GLLibrary.Symbol('glColor3usv');
  ProcVarCast(glColor4b) := GLLibrary.Symbol('glColor4b');
  ProcVarCast(glColor4bv) := GLLibrary.Symbol('glColor4bv');
  ProcVarCast(glColor4d) := GLLibrary.Symbol('glColor4d');
  ProcVarCast(glColor4dv) := GLLibrary.Symbol('glColor4dv');
  ProcVarCast(glColor4f) := GLLibrary.Symbol('glColor4f');
  ProcVarCast(glColor4fv) := GLLibrary.Symbol('glColor4fv');
  ProcVarCast(glColor4i) := GLLibrary.Symbol('glColor4i');
  ProcVarCast(glColor4iv) := GLLibrary.Symbol('glColor4iv');
  ProcVarCast(glColor4s) := GLLibrary.Symbol('glColor4s');
  ProcVarCast(glColor4sv) := GLLibrary.Symbol('glColor4sv');
  ProcVarCast(glColor4ub) := GLLibrary.Symbol('glColor4ub');
  ProcVarCast(glColor4ubv) := GLLibrary.Symbol('glColor4ubv');
  ProcVarCast(glColor4ui) := GLLibrary.Symbol('glColor4ui');
  ProcVarCast(glColor4uiv) := GLLibrary.Symbol('glColor4uiv');
  ProcVarCast(glColor4us) := GLLibrary.Symbol('glColor4us');
  ProcVarCast(glColor4usv) := GLLibrary.Symbol('glColor4usv');
  ProcVarCast(glColorMask) := GLLibrary.Symbol('glColorMask');
  ProcVarCast(glColorMaterial) := GLLibrary.Symbol('glColorMaterial');
  ProcVarCast(glColorPointer) := GLLibrary.Symbol('glColorPointer');
  ProcVarCast(glCopyPixels) := GLLibrary.Symbol('glCopyPixels');
  ProcVarCast(glCopyTexImage1D) := GLLibrary.Symbol('glCopyTexImage1D');
  ProcVarCast(glCopyTexImage2D) := GLLibrary.Symbol('glCopyTexImage2D');
  ProcVarCast(glCopyTexSubImage1D) := GLLibrary.Symbol('glCopyTexSubImage1D');
  ProcVarCast(glCopyTexSubImage2D) := GLLibrary.Symbol('glCopyTexSubImage2D');
  ProcVarCast(glCullFace) := GLLibrary.Symbol('glCullFace');
  ProcVarCast(glDeleteLists) := GLLibrary.Symbol('glDeleteLists');
  ProcVarCast(glDeleteTextures) := GLLibrary.Symbol('glDeleteTextures');
  ProcVarCast(glDepthFunc) := GLLibrary.Symbol('glDepthFunc');
  ProcVarCast(glDepthMask) := GLLibrary.Symbol('glDepthMask');
  ProcVarCast(glDepthRange) := GLLibrary.Symbol('glDepthRange');
  ProcVarCast(glDisable) := GLLibrary.Symbol('glDisable');
  ProcVarCast(glDisableClientState) := GLLibrary.Symbol('glDisableClientState');
  ProcVarCast(glDrawArrays) := GLLibrary.Symbol('glDrawArrays');
  ProcVarCast(glDrawBuffer) := GLLibrary.Symbol('glDrawBuffer');
  ProcVarCast(glDrawElements) := GLLibrary.Symbol('glDrawElements');
  ProcVarCast(glDrawPixels) := GLLibrary.Symbol('glDrawPixels');
  ProcVarCast(glEdgeFlag) := GLLibrary.Symbol('glEdgeFlag');
  ProcVarCast(glEdgeFlagPointer) := GLLibrary.Symbol('glEdgeFlagPointer');
  ProcVarCast(glEdgeFlagv) := GLLibrary.Symbol('glEdgeFlagv');
  ProcVarCast(glEnable) := GLLibrary.Symbol('glEnable');
  ProcVarCast(glEnableClientState) := GLLibrary.Symbol('glEnableClientState');
  ProcVarCast(glEnd) := GLLibrary.Symbol('glEnd');
  ProcVarCast(glEndList) := GLLibrary.Symbol('glEndList');
  ProcVarCast(glEvalCoord1d) := GLLibrary.Symbol('glEvalCoord1d');
  ProcVarCast(glEvalCoord1dv) := GLLibrary.Symbol('glEvalCoord1dv');
  ProcVarCast(glEvalCoord1f) := GLLibrary.Symbol('glEvalCoord1f');
  ProcVarCast(glEvalCoord1fv) := GLLibrary.Symbol('glEvalCoord1fv');
  ProcVarCast(glEvalCoord2d) := GLLibrary.Symbol('glEvalCoord2d');
  ProcVarCast(glEvalCoord2dv) := GLLibrary.Symbol('glEvalCoord2dv');
  ProcVarCast(glEvalCoord2f) := GLLibrary.Symbol('glEvalCoord2f');
  ProcVarCast(glEvalCoord2fv) := GLLibrary.Symbol('glEvalCoord2fv');
  ProcVarCast(glEvalMesh1) := GLLibrary.Symbol('glEvalMesh1');
  ProcVarCast(glEvalMesh2) := GLLibrary.Symbol('glEvalMesh2');
  ProcVarCast(glEvalPoint1) := GLLibrary.Symbol('glEvalPoint1');
  ProcVarCast(glEvalPoint2) := GLLibrary.Symbol('glEvalPoint2');
  ProcVarCast(glFeedbackBuffer) := GLLibrary.Symbol('glFeedbackBuffer');
  ProcVarCast(glFinish) := GLLibrary.Symbol('glFinish');
  ProcVarCast(glFlush) := GLLibrary.Symbol('glFlush');
  ProcVarCast(glFogf) := GLLibrary.Symbol('glFogf');
  ProcVarCast(glFogfv) := GLLibrary.Symbol('glFogfv');
  ProcVarCast(glFogi) := GLLibrary.Symbol('glFogi');
  ProcVarCast(glFogiv) := GLLibrary.Symbol('glFogiv');
  ProcVarCast(glFrontFace) := GLLibrary.Symbol('glFrontFace');
  ProcVarCast(glFrustum) := GLLibrary.Symbol('glFrustum');
  ProcVarCast(glGenLists) := GLLibrary.Symbol('glGenLists');
  ProcVarCast(glGenTextures) := GLLibrary.Symbol('glGenTextures');
  ProcVarCast(glGetBooleanv) := GLLibrary.Symbol('glGetBooleanv');
  ProcVarCast(glGetClipPlane) := GLLibrary.Symbol('glGetClipPlane');
  ProcVarCast(glGetDoublev) := GLLibrary.Symbol('glGetDoublev');
  ProcVarCast(glGetError) := GLLibrary.Symbol('glGetError');
  ProcVarCast(glGetFloatv) := GLLibrary.Symbol('glGetFloatv');
  ProcVarCast(glGetIntegerv) := GLLibrary.Symbol('glGetIntegerv');
  ProcVarCast(glGetLightfv) := GLLibrary.Symbol('glGetLightfv');
  ProcVarCast(glGetLightiv) := GLLibrary.Symbol('glGetLightiv');
  ProcVarCast(glGetMapdv) := GLLibrary.Symbol('glGetMapdv');
  ProcVarCast(glGetMapfv) := GLLibrary.Symbol('glGetMapfv');
  ProcVarCast(glGetMapiv) := GLLibrary.Symbol('glGetMapiv');
  ProcVarCast(glGetMaterialfv) := GLLibrary.Symbol('glGetMaterialfv');
  ProcVarCast(glGetMaterialiv) := GLLibrary.Symbol('glGetMaterialiv');
  ProcVarCast(glGetPixelMapfv) := GLLibrary.Symbol('glGetPixelMapfv');
  ProcVarCast(glGetPixelMapuiv) := GLLibrary.Symbol('glGetPixelMapuiv');
  ProcVarCast(glGetPixelMapusv) := GLLibrary.Symbol('glGetPixelMapusv');
  ProcVarCast(glGetPointerv) := GLLibrary.Symbol('glGetPointerv');
  ProcVarCast(glGetPolygonStipple) := GLLibrary.Symbol('glGetPolygonStipple');
  ProcVarCast(glGetString) := GLLibrary.Symbol('glGetString');
  ProcVarCast(glGetTexEnvfv) := GLLibrary.Symbol('glGetTexEnvfv');
  ProcVarCast(glGetTexEnviv) := GLLibrary.Symbol('glGetTexEnviv');
  ProcVarCast(glGetTexGendv) := GLLibrary.Symbol('glGetTexGendv');
  ProcVarCast(glGetTexGenfv) := GLLibrary.Symbol('glGetTexGenfv');
  ProcVarCast(glGetTexGeniv) := GLLibrary.Symbol('glGetTexGeniv');
  ProcVarCast(glGetTexImage) := GLLibrary.Symbol('glGetTexImage');
  ProcVarCast(glGetTexLevelParameterfv) := GLLibrary.Symbol('glGetTexLevelParameterfv');
  ProcVarCast(glGetTexLevelParameteriv) := GLLibrary.Symbol('glGetTexLevelParameteriv');
  ProcVarCast(glGetTexParameterfv) := GLLibrary.Symbol('glGetTexParameterfv');
  ProcVarCast(glGetTexParameteriv) := GLLibrary.Symbol('glGetTexParameteriv');
  ProcVarCast(glHint) := GLLibrary.Symbol('glHint');
  ProcVarCast(glIndexMask) := GLLibrary.Symbol('glIndexMask');
  ProcVarCast(glIndexPointer) := GLLibrary.Symbol('glIndexPointer');
  ProcVarCast(glIndexd) := GLLibrary.Symbol('glIndexd');
  ProcVarCast(glIndexdv) := GLLibrary.Symbol('glIndexdv');
  ProcVarCast(glIndexf) := GLLibrary.Symbol('glIndexf');
  ProcVarCast(glIndexfv) := GLLibrary.Symbol('glIndexfv');
  ProcVarCast(glIndexi) := GLLibrary.Symbol('glIndexi');
  ProcVarCast(glIndexiv) := GLLibrary.Symbol('glIndexiv');
  ProcVarCast(glIndexs) := GLLibrary.Symbol('glIndexs');
  ProcVarCast(glIndexsv) := GLLibrary.Symbol('glIndexsv');
  ProcVarCast(glIndexub) := GLLibrary.Symbol('glIndexub');
  ProcVarCast(glIndexubv) := GLLibrary.Symbol('glIndexubv');
  ProcVarCast(glInitNames) := GLLibrary.Symbol('glInitNames');
  ProcVarCast(glInterleavedArrays) := GLLibrary.Symbol('glInterleavedArrays');
  ProcVarCast(glIsEnabled) := GLLibrary.Symbol('glIsEnabled');
  ProcVarCast(glIsList) := GLLibrary.Symbol('glIsList');
  ProcVarCast(glIsTexture) := GLLibrary.Symbol('glIsTexture');
  ProcVarCast(glLightModelf) := GLLibrary.Symbol('glLightModelf');
  ProcVarCast(glLightModelfv) := GLLibrary.Symbol('glLightModelfv');
  ProcVarCast(glLightModeli) := GLLibrary.Symbol('glLightModeli');
  ProcVarCast(glLightModeliv) := GLLibrary.Symbol('glLightModeliv');
  ProcVarCast(glLightf) := GLLibrary.Symbol('glLightf');
  ProcVarCast(glLightfv) := GLLibrary.Symbol('glLightfv');
  ProcVarCast(glLighti) := GLLibrary.Symbol('glLighti');
  ProcVarCast(glLightiv) := GLLibrary.Symbol('glLightiv');
  ProcVarCast(glLineStipple) := GLLibrary.Symbol('glLineStipple');
  ProcVarCast(glLineWidth) := GLLibrary.Symbol('glLineWidth');
  ProcVarCast(glListBase) := GLLibrary.Symbol('glListBase');
  ProcVarCast(glLoadIdentity) := GLLibrary.Symbol('glLoadIdentity');
  ProcVarCast(glLoadMatrixd) := GLLibrary.Symbol('glLoadMatrixd');
  ProcVarCast(glLoadMatrixf) := GLLibrary.Symbol('glLoadMatrixf');
  ProcVarCast(glLoadName) := GLLibrary.Symbol('glLoadName');
  ProcVarCast(glLogicOp) := GLLibrary.Symbol('glLogicOp');
  ProcVarCast(glMap1d) := GLLibrary.Symbol('glMap1d');
  ProcVarCast(glMap1f) := GLLibrary.Symbol('glMap1f');
  ProcVarCast(glMap2d) := GLLibrary.Symbol('glMap2d');
  ProcVarCast(glMap2f) := GLLibrary.Symbol('glMap2f');
  ProcVarCast(glMapGrid1d) := GLLibrary.Symbol('glMapGrid1d');
  ProcVarCast(glMapGrid1f) := GLLibrary.Symbol('glMapGrid1f');
  ProcVarCast(glMapGrid2d) := GLLibrary.Symbol('glMapGrid2d');
  ProcVarCast(glMapGrid2f) := GLLibrary.Symbol('glMapGrid2f');
  ProcVarCast(glMaterialf) := GLLibrary.Symbol('glMaterialf');
  ProcVarCast(glMaterialfv) := GLLibrary.Symbol('glMaterialfv');
  ProcVarCast(glMateriali) := GLLibrary.Symbol('glMateriali');
  ProcVarCast(glMaterialiv) := GLLibrary.Symbol('glMaterialiv');
  ProcVarCast(glMatrixMode) := GLLibrary.Symbol('glMatrixMode');
  ProcVarCast(glMultMatrixd) := GLLibrary.Symbol('glMultMatrixd');
  ProcVarCast(glMultMatrixf) := GLLibrary.Symbol('glMultMatrixf');
  ProcVarCast(glNewList) := GLLibrary.Symbol('glNewList');
  ProcVarCast(glNormal3b) := GLLibrary.Symbol('glNormal3b');
  ProcVarCast(glNormal3bv) := GLLibrary.Symbol('glNormal3bv');
  ProcVarCast(glNormal3d) := GLLibrary.Symbol('glNormal3d');
  ProcVarCast(glNormal3dv) := GLLibrary.Symbol('glNormal3dv');
  ProcVarCast(glNormal3f) := GLLibrary.Symbol('glNormal3f');
  ProcVarCast(glNormal3fv) := GLLibrary.Symbol('glNormal3fv');
  ProcVarCast(glNormal3i) := GLLibrary.Symbol('glNormal3i');
  ProcVarCast(glNormal3iv) := GLLibrary.Symbol('glNormal3iv');
  ProcVarCast(glNormal3s) := GLLibrary.Symbol('glNormal3s');
  ProcVarCast(glNormal3sv) := GLLibrary.Symbol('glNormal3sv');
  ProcVarCast(glNormalPointer) := GLLibrary.Symbol('glNormalPointer');
  ProcVarCast(glOrtho) := GLLibrary.Symbol('glOrtho');
  ProcVarCast(glPassThrough) := GLLibrary.Symbol('glPassThrough');
  ProcVarCast(glPixelMapfv) := GLLibrary.Symbol('glPixelMapfv');
  ProcVarCast(glPixelMapuiv) := GLLibrary.Symbol('glPixelMapuiv');
  ProcVarCast(glPixelMapusv) := GLLibrary.Symbol('glPixelMapusv');
  ProcVarCast(glPixelStoref) := GLLibrary.Symbol('glPixelStoref');
  ProcVarCast(glPixelStorei) := GLLibrary.Symbol('glPixelStorei');
  ProcVarCast(glPixelTransferf) := GLLibrary.Symbol('glPixelTransferf');
  ProcVarCast(glPixelTransferi) := GLLibrary.Symbol('glPixelTransferi');
  ProcVarCast(glPixelZoom) := GLLibrary.Symbol('glPixelZoom');
  ProcVarCast(glPointSize) := GLLibrary.Symbol('glPointSize');
  ProcVarCast(glPolygonMode) := GLLibrary.Symbol('glPolygonMode');
  ProcVarCast(glPolygonOffset) := GLLibrary.Symbol('glPolygonOffset');
  ProcVarCast(glPolygonStipple) := GLLibrary.Symbol('glPolygonStipple');
  ProcVarCast(glPopAttrib) := GLLibrary.Symbol('glPopAttrib');
  ProcVarCast(glPopClientAttrib) := GLLibrary.Symbol('glPopClientAttrib');
  ProcVarCast(glPopMatrix) := GLLibrary.Symbol('glPopMatrix');
  ProcVarCast(glPopName) := GLLibrary.Symbol('glPopName');
  ProcVarCast(glPrioritizeTextures) := GLLibrary.Symbol('glPrioritizeTextures');
  ProcVarCast(glPushAttrib) := GLLibrary.Symbol('glPushAttrib');
  ProcVarCast(glPushClientAttrib) := GLLibrary.Symbol('glPushClientAttrib');
  ProcVarCast(glPushMatrix) := GLLibrary.Symbol('glPushMatrix');
  ProcVarCast(glPushName) := GLLibrary.Symbol('glPushName');
  ProcVarCast(glRasterPos2d) := GLLibrary.Symbol('glRasterPos2d');
  ProcVarCast(glRasterPos2dv) := GLLibrary.Symbol('glRasterPos2dv');
  ProcVarCast(glRasterPos2f) := GLLibrary.Symbol('glRasterPos2f');
  ProcVarCast(glRasterPos2fv) := GLLibrary.Symbol('glRasterPos2fv');
  ProcVarCast(glRasterPos2i) := GLLibrary.Symbol('glRasterPos2i');
  ProcVarCast(glRasterPos2iv) := GLLibrary.Symbol('glRasterPos2iv');
  ProcVarCast(glRasterPos2s) := GLLibrary.Symbol('glRasterPos2s');
  ProcVarCast(glRasterPos2sv) := GLLibrary.Symbol('glRasterPos2sv');
  ProcVarCast(glRasterPos3d) := GLLibrary.Symbol('glRasterPos3d');
  ProcVarCast(glRasterPos3dv) := GLLibrary.Symbol('glRasterPos3dv');
  ProcVarCast(glRasterPos3f) := GLLibrary.Symbol('glRasterPos3f');
  ProcVarCast(glRasterPos3fv) := GLLibrary.Symbol('glRasterPos3fv');
  ProcVarCast(glRasterPos3i) := GLLibrary.Symbol('glRasterPos3i');
  ProcVarCast(glRasterPos3iv) := GLLibrary.Symbol('glRasterPos3iv');
  ProcVarCast(glRasterPos3s) := GLLibrary.Symbol('glRasterPos3s');
  ProcVarCast(glRasterPos3sv) := GLLibrary.Symbol('glRasterPos3sv');
  ProcVarCast(glRasterPos4d) := GLLibrary.Symbol('glRasterPos4d');
  ProcVarCast(glRasterPos4dv) := GLLibrary.Symbol('glRasterPos4dv');
  ProcVarCast(glRasterPos4f) := GLLibrary.Symbol('glRasterPos4f');
  ProcVarCast(glRasterPos4fv) := GLLibrary.Symbol('glRasterPos4fv');
  ProcVarCast(glRasterPos4i) := GLLibrary.Symbol('glRasterPos4i');
  ProcVarCast(glRasterPos4iv) := GLLibrary.Symbol('glRasterPos4iv');
  ProcVarCast(glRasterPos4s) := GLLibrary.Symbol('glRasterPos4s');
  ProcVarCast(glRasterPos4sv) := GLLibrary.Symbol('glRasterPos4sv');
  ProcVarCast(glReadBuffer) := GLLibrary.Symbol('glReadBuffer');
  ProcVarCast(glReadPixels) := GLLibrary.Symbol('glReadPixels');
  ProcVarCast(glRectd) := GLLibrary.Symbol('glRectd');
  ProcVarCast(glRectdv) := GLLibrary.Symbol('glRectdv');
  ProcVarCast(glRectf) := GLLibrary.Symbol('glRectf');
  ProcVarCast(glRectfv) := GLLibrary.Symbol('glRectfv');
  ProcVarCast(glRecti) := GLLibrary.Symbol('glRecti');
  ProcVarCast(glRectiv) := GLLibrary.Symbol('glRectiv');
  ProcVarCast(glRects) := GLLibrary.Symbol('glRects');
  ProcVarCast(glRectsv) := GLLibrary.Symbol('glRectsv');
  ProcVarCast(glRenderMode) := GLLibrary.Symbol('glRenderMode');
  ProcVarCast(glRotated) := GLLibrary.Symbol('glRotated');
  ProcVarCast(glRotatef) := GLLibrary.Symbol('glRotatef');
  ProcVarCast(glScaled) := GLLibrary.Symbol('glScaled');
  ProcVarCast(glScalef) := GLLibrary.Symbol('glScalef');
  ProcVarCast(glScissor) := GLLibrary.Symbol('glScissor');
  ProcVarCast(glSelectBuffer) := GLLibrary.Symbol('glSelectBuffer');
  ProcVarCast(glShadeModel) := GLLibrary.Symbol('glShadeModel');
  ProcVarCast(glStencilFunc) := GLLibrary.Symbol('glStencilFunc');
  ProcVarCast(glStencilMask) := GLLibrary.Symbol('glStencilMask');
  ProcVarCast(glStencilOp) := GLLibrary.Symbol('glStencilOp');
  ProcVarCast(glTexCoord1d) := GLLibrary.Symbol('glTexCoord1d');
  ProcVarCast(glTexCoord1dv) := GLLibrary.Symbol('glTexCoord1dv');
  ProcVarCast(glTexCoord1f) := GLLibrary.Symbol('glTexCoord1f');
  ProcVarCast(glTexCoord1fv) := GLLibrary.Symbol('glTexCoord1fv');
  ProcVarCast(glTexCoord1i) := GLLibrary.Symbol('glTexCoord1i');
  ProcVarCast(glTexCoord1iv) := GLLibrary.Symbol('glTexCoord1iv');
  ProcVarCast(glTexCoord1s) := GLLibrary.Symbol('glTexCoord1s');
  ProcVarCast(glTexCoord1sv) := GLLibrary.Symbol('glTexCoord1sv');
  ProcVarCast(glTexCoord2d) := GLLibrary.Symbol('glTexCoord2d');
  ProcVarCast(glTexCoord2dv) := GLLibrary.Symbol('glTexCoord2dv');
  ProcVarCast(glTexCoord2f) := GLLibrary.Symbol('glTexCoord2f');
  ProcVarCast(glTexCoord2fv) := GLLibrary.Symbol('glTexCoord2fv');
  ProcVarCast(glTexCoord2i) := GLLibrary.Symbol('glTexCoord2i');
  ProcVarCast(glTexCoord2iv) := GLLibrary.Symbol('glTexCoord2iv');
  ProcVarCast(glTexCoord2s) := GLLibrary.Symbol('glTexCoord2s');
  ProcVarCast(glTexCoord2sv) := GLLibrary.Symbol('glTexCoord2sv');
  ProcVarCast(glTexCoord3d) := GLLibrary.Symbol('glTexCoord3d');
  ProcVarCast(glTexCoord3dv) := GLLibrary.Symbol('glTexCoord3dv');
  ProcVarCast(glTexCoord3f) := GLLibrary.Symbol('glTexCoord3f');
  ProcVarCast(glTexCoord3fv) := GLLibrary.Symbol('glTexCoord3fv');
  ProcVarCast(glTexCoord3i) := GLLibrary.Symbol('glTexCoord3i');
  ProcVarCast(glTexCoord3iv) := GLLibrary.Symbol('glTexCoord3iv');
  ProcVarCast(glTexCoord3s) := GLLibrary.Symbol('glTexCoord3s');
  ProcVarCast(glTexCoord3sv) := GLLibrary.Symbol('glTexCoord3sv');
  ProcVarCast(glTexCoord4d) := GLLibrary.Symbol('glTexCoord4d');
  ProcVarCast(glTexCoord4dv) := GLLibrary.Symbol('glTexCoord4dv');
  ProcVarCast(glTexCoord4f) := GLLibrary.Symbol('glTexCoord4f');
  ProcVarCast(glTexCoord4fv) := GLLibrary.Symbol('glTexCoord4fv');
  ProcVarCast(glTexCoord4i) := GLLibrary.Symbol('glTexCoord4i');
  ProcVarCast(glTexCoord4iv) := GLLibrary.Symbol('glTexCoord4iv');
  ProcVarCast(glTexCoord4s) := GLLibrary.Symbol('glTexCoord4s');
  ProcVarCast(glTexCoord4sv) := GLLibrary.Symbol('glTexCoord4sv');
  ProcVarCast(glTexCoordPointer) := GLLibrary.Symbol('glTexCoordPointer');
  ProcVarCast(glTexEnvf) := GLLibrary.Symbol('glTexEnvf');
  ProcVarCast(glTexEnvfv) := GLLibrary.Symbol('glTexEnvfv');
  ProcVarCast(glTexEnvi) := GLLibrary.Symbol('glTexEnvi');
  ProcVarCast(glTexEnviv) := GLLibrary.Symbol('glTexEnviv');
  ProcVarCast(glTexGend) := GLLibrary.Symbol('glTexGend');
  ProcVarCast(glTexGendv) := GLLibrary.Symbol('glTexGendv');
  ProcVarCast(glTexGenf) := GLLibrary.Symbol('glTexGenf');
  ProcVarCast(glTexGenfv) := GLLibrary.Symbol('glTexGenfv');
  ProcVarCast(glTexGeni) := GLLibrary.Symbol('glTexGeni');
  ProcVarCast(glTexGeniv) := GLLibrary.Symbol('glTexGeniv');
  ProcVarCast(glTexImage1D) := GLLibrary.Symbol('glTexImage1D');
  ProcVarCast(glTexImage2D) := GLLibrary.Symbol('glTexImage2D');
  ProcVarCast(glTexParameterf) := GLLibrary.Symbol('glTexParameterf');
  ProcVarCast(glTexParameterfv) := GLLibrary.Symbol('glTexParameterfv');
  ProcVarCast(glTexParameteri) := GLLibrary.Symbol('glTexParameteri');
  ProcVarCast(glTexParameteriv) := GLLibrary.Symbol('glTexParameteriv');
  ProcVarCast(glTexSubImage1D) := GLLibrary.Symbol('glTexSubImage1D');
  ProcVarCast(glTexSubImage2D) := GLLibrary.Symbol('glTexSubImage2D');
  ProcVarCast(glTranslated) := GLLibrary.Symbol('glTranslated');
  ProcVarCast(glTranslatef) := GLLibrary.Symbol('glTranslatef');
  ProcVarCast(glVertex2d) := GLLibrary.Symbol('glVertex2d');
  ProcVarCast(glVertex2dv) := GLLibrary.Symbol('glVertex2dv');
  ProcVarCast(glVertex2f) := GLLibrary.Symbol('glVertex2f');
  ProcVarCast(glVertex2fv) := GLLibrary.Symbol('glVertex2fv');
  ProcVarCast(glVertex2i) := GLLibrary.Symbol('glVertex2i');
  ProcVarCast(glVertex2iv) := GLLibrary.Symbol('glVertex2iv');
  ProcVarCast(glVertex2s) := GLLibrary.Symbol('glVertex2s');
  ProcVarCast(glVertex2sv) := GLLibrary.Symbol('glVertex2sv');
  ProcVarCast(glVertex3d) := GLLibrary.Symbol('glVertex3d');
  ProcVarCast(glVertex3dv) := GLLibrary.Symbol('glVertex3dv');
  ProcVarCast(glVertex3f) := GLLibrary.Symbol('glVertex3f');
  ProcVarCast(glVertex3fv) := GLLibrary.Symbol('glVertex3fv');
  ProcVarCast(glVertex3i) := GLLibrary.Symbol('glVertex3i');
  ProcVarCast(glVertex3iv) := GLLibrary.Symbol('glVertex3iv');
  ProcVarCast(glVertex3s) := GLLibrary.Symbol('glVertex3s');
  ProcVarCast(glVertex3sv) := GLLibrary.Symbol('glVertex3sv');
  ProcVarCast(glVertex4d) := GLLibrary.Symbol('glVertex4d');
  ProcVarCast(glVertex4dv) := GLLibrary.Symbol('glVertex4dv');
  ProcVarCast(glVertex4f) := GLLibrary.Symbol('glVertex4f');
  ProcVarCast(glVertex4fv) := GLLibrary.Symbol('glVertex4fv');
  ProcVarCast(glVertex4i) := GLLibrary.Symbol('glVertex4i');
  ProcVarCast(glVertex4iv) := GLLibrary.Symbol('glVertex4iv');
  ProcVarCast(glVertex4s) := GLLibrary.Symbol('glVertex4s');
  ProcVarCast(glVertex4sv) := GLLibrary.Symbol('glVertex4sv');
  ProcVarCast(glVertexPointer) := GLLibrary.Symbol('glVertexPointer');
  ...
  ProcVarCast(wglCreateLayerContext) := GLLibrary.Symbol('wglCreateLayerContext');
  ProcVarCast(wglDeleteContext) := GLLibrary.Symbol('wglDeleteContext');
  ProcVarCast(wglDescribeLayerPlane) := GLLibrary.Symbol('wglDescribeLayerPlane');
  ProcVarCast(wglGetCurrentContext) := GLLibrary.Symbol('wglGetCurrentContext');
  ProcVarCast(wglGetCurrentDC) := GLLibrary.Symbol('wglGetCurrentDC');
  ProcVarCast(wglGetLayerPaletteEntries) := GLLibrary.Symbol('wglGetLayerPaletteEntries');
  ProcVarCast(wglMakeCurrent) := GLLibrary.Symbol('wglMakeCurrent');
  ProcVarCast(wglRealizeLayerPalette) := GLLibrary.Symbol('wglRealizeLayerPalette');
  ProcVarCast(wglSetLayerPaletteEntries) := GLLibrary.Symbol('wglSetLayerPaletteEntries');
  ProcVarCast(wglShareLists) := GLLibrary.Symbol('wglShareLists');
  ProcVarCast(wglSwapLayerBuffers) := GLLibrary.Symbol('wglSwapLayerBuffers');
  {$ifndef OLDER_WGL}
    ProcVarCast(wglSwapMultipleBuffers) := GLLibrary.Symbol('wglSwapMultipleBuffers');
  {$endif}
  ProcVarCast(wglUseFontBitmapsA) := GLLibrary.Symbol('wglUseFontBitmapsA');
  ProcVarCast(wglUseFontOutlinesA) := GLLibrary.Symbol('wglUseFontOutlinesA');
  ProcVarCast(wglUseFontBitmapsW) := GLLibrary.Symbol('wglUseFontBitmapsW');
  ProcVarCast(wglUseFontOutlinesW) := GLLibrary.Symbol('wglUseFontOutlinesW');
  ProcVarCast(wglUseFontBitmaps) := GLLibrary.Symbol('wglUseFontBitmapsA');
  ProcVarCast(wglUseFontOutlines) := GLLibrary.Symbol('wglUseFontOutlinesA');
  {$ENDIF}

  {$ifndef NO_GL_12}
  { GL 1.2 }
  ProcVarCast(glDrawRangeElements) := GLLibrary.Symbol('glDrawRangeElements');
  ProcVarCast(glTexImage3D) := GLLibrary.Symbol('glTexImage3D');

  { GL 1.2 ARB imaging }
  ProcVarCast(glBlendColor) := GLLibrary.Symbol('glBlendColor');
  ProcVarCast(glBlendEquation) := GLLibrary.Symbol('glBlendEquation');
  ProcVarCast(glColorSubTable) := GLLibrary.Symbol('glColorSubTable');
  ProcVarCast(glCopyColorSubTable) := GLLibrary.Symbol('glCopyColorSubTable');
  ProcVarCast(glColorTable) := GLLibrary.Symbol('glCopyColorSubTable');
  ProcVarCast(glCopyColorTable) := GLLibrary.Symbol('glCopyColorTable');
  ProcVarCast(glColorTableParameteriv) := GLLibrary.Symbol('glColorTableParameteriv');
  ProcVarCast(glColorTableParameterfv) := GLLibrary.Symbol('glColorTableParameterfv');
  ProcVarCast(glGetColorTable) := GLLibrary.Symbol('glGetColorTable');
  ProcVarCast(glGetColorTableParameteriv) := GLLibrary.Symbol('glGetColorTableParameteriv');
  ProcVarCast(glGetColorTableParameterfv) := GLLibrary.Symbol('glGetColorTableParameterfv');
  ProcVarCast(glConvolutionFilter1D) := GLLibrary.Symbol('glConvolutionFilter1D');
  ProcVarCast(glConvolutionFilter2D) := GLLibrary.Symbol('glConvolutionFilter2D');
  ProcVarCast(glCopyConvolutionFilter1D) := GLLibrary.Symbol('glCopyConvolutionFilter1D');
  ProcVarCast(glCopyConvolutionFilter2D) := GLLibrary.Symbol('glCopyConvolutionFilter2D');
  ProcVarCast(glGetConvolutionFilter) := GLLibrary.Symbol('glGetConvolutionFilter');
  ProcVarCast(glSeparableFilter2D) := GLLibrary.Symbol('glSeparableFilter2D');
  ProcVarCast(glGetSeparableFilter) := GLLibrary.Symbol('glGetSeparableFilter');
  ProcVarCast(glConvolutionParameteri) := GLLibrary.Symbol('glConvolutionParameteri');
  ProcVarCast(glConvolutionParameteriv) := GLLibrary.Symbol('glConvolutionParameteriv');
  ProcVarCast(glConvolutionParameterf) := GLLibrary.Symbol('glConvolutionParameterf');
  ProcVarCast(glConvolutionParameterfv) := GLLibrary.Symbol('glConvolutionParameterfv');
  ProcVarCast(glGetConvolutionParameteriv) := GLLibrary.Symbol('glGetConvolutionParameteriv');
  ProcVarCast(glGetConvolutionParameterfv) := GLLibrary.Symbol('glGetConvolutionParameterfv');
  ProcVarCast(glHistogram) := GLLibrary.Symbol('glHistogram');
  ProcVarCast(glResetHistogram) := GLLibrary.Symbol('glResetHistogram');
  ProcVarCast(glGetHistogram) := GLLibrary.Symbol('glGetHistogram');
  ProcVarCast(glGetHistogramParameteriv) := GLLibrary.Symbol('glGetHistogramParameteriv');
  ProcVarCast(glGetHistogramParameterfv) := GLLibrary.Symbol('glGetHistogramParameterfv');
  ProcVarCast(glMinmax) := GLLibrary.Symbol('glMinmax');
  ProcVarCast(glResetMinmax) := GLLibrary.Symbol('glResetMinmax');
  ProcVarCast(glGetMinmax) := GLLibrary.Symbol('glGetMinmax');
 ...
 begin
  ProcVarCast(gluBeginCurve) := GLULibrary.Symbol('gluBeginCurve');
  ProcVarCast(gluBeginPolygon) := GLULibrary.Symbol('gluBeginPolygon');
  ProcVarCast(gluBeginSurface) := GLULibrary.Symbol('gluBeginSurface');
  ProcVarCast(gluBeginTrim) := GLULibrary.Symbol('gluBeginTrim');
  ProcVarCast(gluBuild1DMipmaps) := GLULibrary.Symbol('gluBuild1DMipmaps');
  ProcVarCast(gluBuild2DMipmaps) := GLULibrary.Symbol('gluBuild2DMipmaps');
  ProcVarCast(gluCylinder) := GLULibrary.Symbol('gluCylinder');
  ProcVarCast(gluDeleteNurbsRenderer) := GLULibrary.Symbol('gluDeleteNurbsRenderer');
  ProcVarCast(gluDeleteQuadric) := GLULibrary.Symbol('gluDeleteQuadric');
  ProcVarCast(gluDeleteTess) := GLULibrary.Symbol('gluDeleteTess');
  ProcVarCast(gluDisk) := GLULibrary.Symbol('gluDisk');
  ProcVarCast(gluEndCurve) := GLULibrary.Symbol('gluEndCurve');
  ProcVarCast(gluEndPolygon) := GLULibrary.Symbol('gluEndPolygon');
  ProcVarCast(gluEndSurface) := GLULibrary.Symbol('gluEndSurface');
  ProcVarCast(gluEndTrim) := GLULibrary.Symbol('gluEndTrim');
  ProcVarCast(gluErrorString) := GLULibrary.Symbol('gluErrorString');
  ProcVarCast(gluGetNurbsProperty) := GLULibrary.Symbol('gluGetNurbsProperty');
  ProcVarCast(gluGetString) := GLULibrary.Symbol('gluGetString');
  ProcVarCast(gluGetTessProperty) := GLULibrary.Symbol('gluGetTessProperty');
  ProcVarCast(gluLoadSamplingMatrices) := GLULibrary.Symbol('gluLoadSamplingMatrices');
  ProcVarCast(gluLookAt) := GLULibrary.Symbol('gluLookAt');
  ProcVarCast(gluNewNurbsRenderer) := GLULibrary.Symbol('gluNewNurbsRenderer');
  ProcVarCast(gluNewQuadric) := GLULibrary.Symbol('gluNewQuadric');
  ProcVarCast(gluNewTess) := GLULibrary.Symbol('gluNewTess');
  ProcVarCast(gluNextContour) := GLULibrary.Symbol('gluNextContour');
  ProcVarCast(gluNurbsCallback) := GLULibrary.Symbol('gluNurbsCallback');
  ProcVarCast(gluNurbsCurve) := GLULibrary.Symbol('gluNurbsCurve');
  ProcVarCast(gluNurbsProperty) := GLULibrary.Symbol('gluNurbsProperty');
  ProcVarCast(gluNurbsSurface) := GLULibrary.Symbol('gluNurbsSurface');
  ProcVarCast(gluOrtho2D) := GLULibrary.Symbol('gluOrtho2D');
  ProcVarCast(gluPartialDisk) := GLULibrary.Symbol('gluPartialDisk');
  ProcVarCast(gluPerspective) := GLULibrary.Symbol('gluPerspective');
  ProcVarCast(gluPickMatrix) := GLULibrary.Symbol('gluPickMatrix');
  ProcVarCast(gluProject) := GLULibrary.Symbol('gluProject');
  ProcVarCast(gluPwlCurve) := GLULibrary.Symbol('gluPwlCurve');
  ProcVarCast(gluQuadricCallback) := GLULibrary.Symbol('gluQuadricCallback');
  ProcVarCast(gluQuadricDrawStyle) := GLULibrary.Symbol('gluQuadricDrawStyle');
  ProcVarCast(gluQuadricNormals) := GLULibrary.Symbol('gluQuadricNormals');
  ProcVarCast(gluQuadricOrientation) := GLULibrary.Symbol('gluQuadricOrientation');
  ProcVarCast(gluQuadricTexture) := GLULibrary.Symbol('gluQuadricTexture');
  ProcVarCast(gluScaleImage) := GLULibrary.Symbol('gluScaleImage');
  ProcVarCast(gluSphere) := GLULibrary.Symbol('gluSphere');
  ProcVarCast(gluTessBeginContour) := GLULibrary.Symbol('gluTessBeginContour');
  ProcVarCast(gluTessBeginPolygon) := GLULibrary.Symbol('gluTessBeginPolygon');
  ProcVarCast(gluTessCallback) := GLULibrary.Symbol('gluTessCallback');
  ProcVarCast(gluTessEndContour) := GLULibrary.Symbol('gluTessEndContour');
  ProcVarCast(gluTessEndPolygon) := GLULibrary.Symbol('gluTessEndPolygon');
  ProcVarCast(gluTessNormal) := GLULibrary.Symbol('gluTessNormal');
  ProcVarCast(gluTessProperty) := GLULibrary.Symbol('gluTessProperty');
  ProcVarCast(gluTessVertex) := GLULibrary.Symbol('gluTessVertex');
  ProcVarCast(gluUnProject) := GLULibrary.Symbol('gluUnProject');
 end;
...
begin
 ...
 try
  ...
  ProcVarCast(glArrayElementEXT) := LoadExtensionFunction('glArrayElementEXT');
  ProcVarCast(glDrawArraysEXT) := LoadExtensionFunction('glDrawArraysEXT');
  ProcVarCast(glVertexPointerEXT) := LoadExtensionFunction('glVertexPointerEXT');
  ProcVarCast(glNormalPointerEXT) := LoadExtensionFunction('glNormalPointerEXT');
  ProcVarCast(glColorPointerEXT) := LoadExtensionFunction('glColorPointerEXT');
  ProcVarCast(glIndexPointerEXT) := LoadExtensionFunction('glIndexPointerEXT');
  ProcVarCast(glTexCoordPointerEXT) := LoadExtensionFunction('glTexCoordPointerEXT');
  ProcVarCast(glEdgeFlagPointerEXT) := LoadExtensionFunction('glEdgeFlagPointerEXT');
  ProcVarCast(glGetPointervEXT) := LoadExtensionFunction('glGetPointervEXT');
  ProcVarCast(glArrayElementArrayEXT) := LoadExtensionFunction('glArrayElementArrayEXT');
  ProcVarCast(glAddSwapHintRectWIN) := LoadExtensionFunction('glAddSwapHintRectWIN');
  ProcVarCast(glColorTableEXT) := LoadExtensionFunction('glColorTableEXT');
  ProcVarCast(glColorSubTableEXT) := LoadExtensionFunction('glColorSubTableEXT');
  ProcVarCast(glGetColorTableEXT) := LoadExtensionFunction('glGetColorTableEXT');
  ProcVarCast(glGetColorTablePameterivEXT) := LoadExtensionFunction('glGetColorTablePameterivEXT');
  ProcVarCast(glGetColorTablePameterfvEXT) := LoadExtensionFunction('glGetColorTablePameterfvEXT');
  ProcVarCast(gluNurbsCallbackDataEXT) := LoadExtensionFunction('gluNurbsCallbackDataEXT');
  ProcVarCast(gluNewNurbsTessellatorEXT) := LoadExtensionFunction('gluNewNurbsTessellatorEXT');
  ProcVarCast(gluDeleteNurbsTessellatorEXT) := LoadExtensionFunction('gluDeleteNurbsTessellatorEXT');
  ProcVarCast(glLockArraysEXT) := LoadExtensionFunction('glLockArraysEXT');
  ProcVarCast(glUnlockArraysEXT) := LoadExtensionFunction('glUnlockArraysEXT');
  ProcVarCast(glCopyTexImage1DEXT) := LoadExtensionFunction('glCopyTexImage1DEXT');
  ProcVarCast(glCopyTexSubImage1DEXT) := LoadExtensionFunction('glCopyTexSubImage1DEXT');
  ProcVarCast(glCopyTexImage2DEXT) := LoadExtensionFunction('glCopyTexImage2DEXT');
  ProcVarCast(glCopyTexSubImage2DEXT) := LoadExtensionFunction('glCopyTexSubImage2DEXT');
  ProcVarCast(glCopyTexSubImage3DEXT) := LoadExtensionFunction('glCopyTexSubImage3DEXT');
  ProcVarCast(glCullParameterfvEXT) := LoadExtensionFunction('glCullParameterfvEXT');
  ProcVarCast(glCullParameterdvEXT) := LoadExtensionFunction('glCullParameterdvEXT');
  ProcVarCast(glIndexFuncEXT) := LoadExtensionFunction('glIndexFuncEXT');
  ProcVarCast(glIndexMaterialEXT) := LoadExtensionFunction('glIndexMaterialEXT');
  ProcVarCast(glPolygonOffsetEXT) := LoadExtensionFunction('glPolygonOffsetEXT');
  ProcVarCast(glTexSubImage1DEXT) := LoadExtensionFunction('glTexSubImage1DEXT');
  ProcVarCast(glTexSubImage2DEXT) := LoadExtensionFunction('glTexSubImage2DEXT');
  ProcVarCast(glTexSubImage3DEXT) := LoadExtensionFunction('glTexSubImage3DEXT');
  ProcVarCast(glGenTexturesEXT) := LoadExtensionFunction('glGenTexturesEXT');
  ProcVarCast(glDeleteTexturesEXT) := LoadExtensionFunction('glDeleteTexturesEXT');
  ProcVarCast(glBindTextureEXT) := LoadExtensionFunction('glBindTextureEXT');
  ProcVarCast(glPrioritizeTexturesEXT) := LoadExtensionFunction('glPrioritizeTexturesEXT');
  ProcVarCast(glAreTexturesResidentEXT) := LoadExtensionFunction('glAreTexturesResidentEXT');
  ProcVarCast(glIsTextureEXT) := LoadExtensionFunction('glIsTextureEXT');

  ProcVarCast(glMultiTexCoord1dARB) := LoadExtensionFunction('glMultiTexCoord1dARB');
  ProcVarCast(glMultiTexCoord1dVARB) := LoadExtensionFunction('glMultiTexCoord1dVARB');
  ProcVarCast(glMultiTexCoord1fARBP) := LoadExtensionFunction('glMultiTexCoord1fARBP');
  ProcVarCast(glMultiTexCoord1fVARB) := LoadExtensionFunction('glMultiTexCoord1fVARB');
  ProcVarCast(glMultiTexCoord1iARB) := LoadExtensionFunction('glMultiTexCoord1iARB');
  ProcVarCast(glMultiTexCoord1iVARB) := LoadExtensionFunction('glMultiTexCoord1iVARB');
  ProcVarCast(glMultiTexCoord1sARBP) := LoadExtensionFunction('glMultiTexCoord1sARBP');
  ProcVarCast(glMultiTexCoord1sVARB) := LoadExtensionFunction('glMultiTexCoord1sVARB');
  ProcVarCast(glMultiTexCoord2dARB) := LoadExtensionFunction('glMultiTexCoord2dARB');
  ProcVarCast(glMultiTexCoord2dvARB) := LoadExtensionFunction('glMultiTexCoord2dvARB');
  ProcVarCast(glMultiTexCoord2fARB) := LoadExtensionFunction('glMultiTexCoord2fARB');
  ProcVarCast(glMultiTexCoord2fvARB) := LoadExtensionFunction('glMultiTexCoord2fvARB');
  ProcVarCast(glMultiTexCoord2iARB) := LoadExtensionFunction('glMultiTexCoord2iARB');
  ProcVarCast(glMultiTexCoord2ivARB) := LoadExtensionFunction('glMultiTexCoord2ivARB');
  ProcVarCast(glMultiTexCoord2sARB) := LoadExtensionFunction('glMultiTexCoord2sARB');
  ProcVarCast(glMultiTexCoord2svARB) := LoadExtensionFunction('glMultiTexCoord2svARB');
  ProcVarCast(glMultiTexCoord3dARB) := LoadExtensionFunction('glMultiTexCoord3dARB');
  ProcVarCast(glMultiTexCoord3dvARB) := LoadExtensionFunction('glMultiTexCoord3dvARB');
  ProcVarCast(glMultiTexCoord3fARB) := LoadExtensionFunction('glMultiTexCoord3fARB');
  ProcVarCast(glMultiTexCoord3fvARB) := LoadExtensionFunction('glMultiTexCoord3fvARB');
  ProcVarCast(glMultiTexCoord3iARB) := LoadExtensionFunction('glMultiTexCoord3iARB');
  ProcVarCast(glMultiTexCoord3ivARB) := LoadExtensionFunction('glMultiTexCoord3ivARB');
  ProcVarCast(glMultiTexCoord3sARB) := LoadExtensionFunction('glMultiTexCoord3sARB');
  ProcVarCast(glMultiTexCoord3svARB) := LoadExtensionFunction('glMultiTexCoord3svARB');
  ProcVarCast(glMultiTexCoord4dARB) := LoadExtensionFunction('glMultiTexCoord4dARB');
  ProcVarCast(glMultiTexCoord4dvARB) := LoadExtensionFunction('glMultiTexCoord4dvARB');
  ProcVarCast(glMultiTexCoord4fARB) := LoadExtensionFunction('glMultiTexCoord4fARB');
  ProcVarCast(glMultiTexCoord4fvARB) := LoadExtensionFunction('glMultiTexCoord4fvARB');
  ProcVarCast(glMultiTexCoord4iARB) := LoadExtensionFunction('glMultiTexCoord4iARB');
  ProcVarCast(glMultiTexCoord4ivARB) := LoadExtensionFunction('glMultiTexCoord4ivARB');
  ProcVarCast(glMultiTexCoord4sARB) := LoadExtensionFunction('glMultiTexCoord4sARB');
  ProcVarCast(glMultiTexCoord4svARB) := LoadExtensionFunction('glMultiTexCoord4svARB');
  ProcVarCast(glActiveTextureARB) := LoadExtensionFunction('glActiveTextureARB');
  ProcVarCast(glClientActiveTextureARB) := LoadExtensionFunction('glClientActiveTextureARB');

   { EXT_compiled_vertex_array }
  ProcVarCast(glLockArrayEXT) := LoadExtensionFunction('glLockArrayEXT');
  ProcVarCast(glUnlockArrayEXT) := LoadExtensionFunction('glUnlockArrayEXT');
  ...
  ProcVarCast(glAddSwapHintRectWIN) := LoadExtensionFunction('glAddSwapHintRectWIN');
   ...
   { EXT_point_parameter }
  ProcVarCast(glPointParameterfEXT) := LoadExtensionFunction('glPointParameterfEXT');
  ProcVarCast(glPointParameterfvEXT) := LoadExtensionFunction('glPointParameterfvEXT');

   { GL_ARB_transpose_matrix }
  ProcVarCast(glLoadTransposeMatrixfARB) := LoadExtensionFunction('glLoadTransposeMatrixfARB');
  ProcVarCast(glLoadTransposeMatrixdARB) := LoadExtensionFunction('glLoadTransposeMatrixdARB');
  ProcVarCast(glMultTransposeMatrixfARB) := LoadExtensionFunction('glMultTransposeMatrixfARB');
  ProcVarCast(glMultTransposeMatrixdARB) := LoadExtensionFunction('glMultTransposeMatrixdARB');

  ProcVarCast(glSampleCoverageARB) := LoadExtensionFunction('glSampleCoverageARB');
  ProcVarCast(glSamplePassARB) := LoadExtensionFunction('glSamplePassARB');

   { GL_ARB_multisample }
  ProcVarCast(glCompressedTexImage3DARB) := LoadExtensionFunction('glCompressedTexImage3DARB');
  ProcVarCast(glCompressedTexImage2DARB) := LoadExtensionFunction('glCompressedTexImage2DARB');
  ProcVarCast(glCompressedTexImage1DARB) := LoadExtensionFunction('glCompressedTexImage1DARB');
  ProcVarCast(glCompressedTexSubImage3DARB) := LoadExtensionFunction('glCompressedTexSubImage3DARB');
  ProcVarCast(glCompressedTexSubImage2DARB) := LoadExtensionFunction('glCompressedTexSubImage2DARB');
  ProcVarCast(glCompressedTexSubImage1DARB) := LoadExtensionFunction('glCompressedTexSubImage1DARB');
  ProcVarCast(glGetCompressedTexImageARB) := LoadExtensionFunction('glGetCompressedTexImageARB');

   { GL_EXT_blend_color }
  ProcVarCast(glBlendColorEXT) := LoadExtensionFunction('glBlendColorEXT');

   { GL_EXT_texture3D }
  ProcVarCast(glTexImage3DEXT) := LoadExtensionFunction('glTexImage3DEXT');

   { GL_SGIS_texture_filter4 }
  ProcVarCast(glGetTexFilterFuncSGIS) := LoadExtensionFunction('glGetTexFilterFuncSGIS');
  ProcVarCast(glTexFilterFuncSGIS) := LoadExtensionFunction('glTexFilterFuncSGIS');

   { GL_EXT_histogram }
  ProcVarCast(glGetHistogramEXT) := LoadExtensionFunction('glGetHistogramEXT');
  ProcVarCast(glGetHistogramParameterfvEXT) := LoadExtensionFunction('glGetHistogramParameterfvEXT');
  ProcVarCast(glGetHistogramParameterivEXT) := LoadExtensionFunction('glGetHistogramParameterivEXT');
  ProcVarCast(glGetMinmaxEXT) := LoadExtensionFunction('glGetMinmaxEXT');
  ProcVarCast(glGetMinmaxParameterfvEXT) := LoadExtensionFunction('glGetMinmaxParameterfvEXT');
  ProcVarCast(glGetMinmaxParameterivEXT) := LoadExtensionFunction('glGetMinmaxParameterivEXT');
  ProcVarCast(glHistogramEXT) := LoadExtensionFunction('glHistogramEXT');
  ProcVarCast(glMinmaxEXT) := LoadExtensionFunction('glMinmaxEXT');
  ProcVarCast(glResetHistogramEXT) := LoadExtensionFunction('glResetHistogramEXT');
  ProcVarCast(glResetMinmaxEXT) := LoadExtensionFunction('glResetMinmaxEXT');

   { GL_EXT_convolution }
  ProcVarCast(glConvolutionFilter1DEXT) := LoadExtensionFunction('glConvolutionFilter1DEXT');
  ProcVarCast(glConvolutionFilter2DEXT) := LoadExtensionFunction('glConvolutionFilter2DEXT');
  ProcVarCast(glConvolutionParameterfEXT) := LoadExtensionFunction('glConvolutionParameterfEXT');
  ProcVarCast(glConvolutionParameterfvEXT) := LoadExtensionFunction('glConvolutionParameterfvEXT');
  ProcVarCast(glConvolutionParameteriEXT) := LoadExtensionFunction('glConvolutionParameteriEXT');
  ProcVarCast(glConvolutionParameterivEXT) := LoadExtensionFunction('glConvolutionParameterivEXT');
  ProcVarCast(glCopyConvolutionFilter1DEXT) := LoadExtensionFunction('glCopyConvolutionFilter1DEXT');
  ProcVarCast(glCopyConvolutionFilter2DEXT) := LoadExtensionFunction('glCopyConvolutionFilter2DEXT');
  ProcVarCast(glGetConvolutionFilterEXT) := LoadExtensionFunction('glGetConvolutionFilterEXT');
  ProcVarCast(glGetConvolutionParameterfvEXT) := LoadExtensionFunction('glGetConvolutionParameterfvEXT');
  ProcVarCast(glGetConvolutionParameterivEXT) := LoadExtensionFunction('glGetConvolutionParameterivEXT');
  ProcVarCast(glGetSeparableFilterEXT) := LoadExtensionFunction('glGetSeparableFilterEXT');
  ProcVarCast(glSeparableFilter2DEXT) := LoadExtensionFunction('glSeparableFilter2DEXT');

   { GL_SGI_color_table }
  ProcVarCast(glColorTableSGI) := LoadExtensionFunction('glColorTableSGI');
  ProcVarCast(glColorTableParameterfvSGI) := LoadExtensionFunction('glColorTableParameterfvSGI');
  ProcVarCast(glColorTableParameterivSGI) := LoadExtensionFunction('glColorTableParameterivSGI');
  ProcVarCast(glCopyColorTableSGI) := LoadExtensionFunction('glCopyColorTableSGI');
  ProcVarCast(glGetColorTableSGI) := LoadExtensionFunction('glGetColorTableSGI');
  ProcVarCast(glGetColorTableParameterfvSGI) := LoadExtensionFunction('glGetColorTableParameterfvSGI');
  ProcVarCast(glGetColorTableParameterivSGI) := LoadExtensionFunction('glGetColorTableParameterivSGI');

   { GL_SGIX_pixel_texture }
  ProcVarCast(glPixelTexGenSGIX) := LoadExtensionFunction('glPixelTexGenSGIX');

   { GL_SGIS_pixel_texture }
  ProcVarCast(glPixelTexGenParameteriSGIS) := LoadExtensionFunction('glPixelTexGenParameteriSGIS');
  ProcVarCast(glPixelTexGenParameterivSGIS) := LoadExtensionFunction('glPixelTexGenParameterivSGIS');
  ProcVarCast(glPixelTexGenParameterfSGIS) := LoadExtensionFunction('glPixelTexGenParameterfSGIS');
  ProcVarCast(glPixelTexGenParameterfvSGIS) := LoadExtensionFunction('glPixelTexGenParameterfvSGIS');
  ProcVarCast(glGetPixelTexGenParameterivSGIS) := LoadExtensionFunction('glGetPixelTexGenParameterivSGIS');
  ProcVarCast(glGetPixelTexGenParameterfvSGIS) := LoadExtensionFunction('glGetPixelTexGenParameterfvSGIS');

   { GL_SGIS_texture4D }
  ProcVarCast(glTexImage4DSGIS) := LoadExtensionFunction('glTexImage4DSGIS');
  ProcVarCast(glTexSubImage4DSGIS) := LoadExtensionFunction('glTexSubImage4DSGIS');

   { GL_SGIS_detail_texture }
  ProcVarCast(glDetailTexFuncSGIS) := LoadExtensionFunction('glDetailTexFuncSGIS');
  ProcVarCast(glGetDetailTexFuncSGIS) := LoadExtensionFunction('glGetDetailTexFuncSGIS');

   { GL_SGIS_sharpen_texture }
  ProcVarCast(glSharpenTexFuncSGIS) := LoadExtensionFunction('glSharpenTexFuncSGIS');
  ProcVarCast(glGetSharpenTexFuncSGIS) := LoadExtensionFunction('glGetSharpenTexFuncSGIS');

   { GL_SGIS_multisample }
  ProcVarCast(glSampleMaskSGIS) := LoadExtensionFunction('glSampleMaskSGIS');
  ProcVarCast(glSamplePatternSGIS) := LoadExtensionFunction('glSamplePatternSGIS');

   { GL_EXT_blend_minmax }
  ProcVarCast(glBlendEquationEXT) := LoadExtensionFunction('glBlendEquationEXT');

   { GL_SGIX_sprite }
  ProcVarCast(glSpriteParameterfSGIX) := LoadExtensionFunction('glSpriteParameterfSGIX');
  ProcVarCast(glSpriteParameterfvSGIX) := LoadExtensionFunction('glSpriteParameterfvSGIX');
  ProcVarCast(glSpriteParameteriSGIX) := LoadExtensionFunction('glSpriteParameteriSGIX');
  ProcVarCast(glSpriteParameterivSGIX) := LoadExtensionFunction('glSpriteParameterivSGIX');

   { GL_EXT_point_parameters }
  ProcVarCast(glPointParameterfSGIS) := LoadExtensionFunction('glPointParameterfSGIS');
  ProcVarCast(glPointParameterfvSGIS) := LoadExtensionFunction('glPointParameterfvSGIS');

   { GL_SGIX_instruments }
  ProcVarCast(glGetInstrumentsSGIX) := LoadExtensionFunction('glGetInstrumentsSGIX');
  ProcVarCast(glInstrumentsBufferSGIX) := LoadExtensionFunction('glInstrumentsBufferSGIX');
  ProcVarCast(glPollInstrumentsSGIX) := LoadExtensionFunction('glPollInstrumentsSGIX');
  ProcVarCast(glReadInstrumentsSGIX) := LoadExtensionFunction('glReadInstrumentsSGIX');
  ProcVarCast(glStartInstrumentsSGIX) := LoadExtensionFunction('glStartInstrumentsSGIX');
  ProcVarCast(glStopInstrumentsSGIX) := LoadExtensionFunction('glStopInstrumentsSGIX');

   { GL_SGIX_framezoom }
  ProcVarCast(glFrameZoomSGIX) := LoadExtensionFunction('glFrameZoomSGIX');

   { GL_SGIX_tag_sample_buffer }
  ProcVarCast(glTagSampleBufferSGIX) := LoadExtensionFunction('glTagSampleBufferSGIX');

   { GL_SGIX_polynomial_ffd }
  ProcVarCast(glDeformationMap3dSGIX) := LoadExtensionFunction('glDeformationMap3dSGIX');
  ProcVarCast(glDeformationMap3fSGIX) := LoadExtensionFunction('glDeformationMap3fSGIX');
  ProcVarCast(glDeformSGIX) := LoadExtensionFunction('glDeformSGIX');
  ProcVarCast(glLoadIdentityDeformationMapSGIX) := LoadExtensionFunction('glLoadIdentityDeformationMapSGIX');

   { GL_SGIX_reference_plane }
  ProcVarCast(glReferencePlaneSGIX) := LoadExtensionFunction('glReferencePlaneSGIX');

   { GL_SGIX_flush_raster }
  ProcVarCast(glFlushRasterSGIX) := LoadExtensionFunction('glFlushRasterSGIX');

   { GL_SGIS_fog_function }
  ProcVarCast(glFogFuncSGIS) := LoadExtensionFunction('glFogFuncSGIS');
  ProcVarCast(glGetFogFuncSGIS) := LoadExtensionFunction('glGetFogFuncSGIS');

   { GL_HP_image_transform }
  ProcVarCast(glImageTransformParameteriHP) := LoadExtensionFunction('glImageTransformParameteriHP');
  ProcVarCast(glImageTransformParameterfHP) := LoadExtensionFunction('glImageTransformParameterfHP');
  ProcVarCast(glImageTransformParameterivHP) := LoadExtensionFunction('glImageTransformParameterivHP');
  ProcVarCast(glImageTransformParameterfvHP) := LoadExtensionFunction('glImageTransformParameterfvHP');
  ProcVarCast(glGetImageTransformParameterivHP) := LoadExtensionFunction('glGetImageTransformParameterivHP');
  ProcVarCast(glGetImageTransformParameterfvHP) := LoadExtensionFunction('glGetImageTransformParameterfvHP');

   { GL_EXT_color_subtable }
  ProcVarCast(glCopyColorSubTableEXT) := LoadExtensionFunction('glCopyColorSubTableEXT');

   { GL_PGI_misc_hints }
  ProcVarCast(glHintPGI) := LoadExtensionFunction('glHintPGI');

   { GL_EXT_paletted_texture }
  ProcVarCast(glGetColorTableParameterivEXT) := LoadExtensionFunction('glGetColorTableParameterivEXT');
  ProcVarCast(glGetColorTableParameterfvEXT) := LoadExtensionFunction('glGetColorTableParameterfvEXT');

   { GL_SGIX_list_priority }
  ProcVarCast(glGetListParameterfvSGIX) := LoadExtensionFunction('glGetListParameterfvSGIX');
  ProcVarCast(glGetListParameterivSGIX) := LoadExtensionFunction('glGetListParameterivSGIX');
  ProcVarCast(glListParameterfSGIX) := LoadExtensionFunction('glListParameterfSGIX');
  ProcVarCast(glListParameterfvSGIX) := LoadExtensionFunction('glListParameterfvSGIX');
  ProcVarCast(glListParameteriSGIX) := LoadExtensionFunction('glListParameteriSGIX');
  ProcVarCast(glListParameterivSGIX) := LoadExtensionFunction('glListParameterivSGIX');

   { GL_SGIX_fragment_lighting }
  ProcVarCast(glFragmentColorMaterialSGIX) := LoadExtensionFunction('glFragmentColorMaterialSGIX');
  ProcVarCast(glFragmentLightfSGIX) := LoadExtensionFunction('glFragmentLightfSGIX');
  ProcVarCast(glFragmentLightfvSGIX) := LoadExtensionFunction('glFragmentLightfvSGIX');
  ProcVarCast(glFragmentLightiSGIX) := LoadExtensionFunction('glFragmentLightiSGIX');
  ProcVarCast(glFragmentLightivSGIX) := LoadExtensionFunction('glFragmentLightivSGIX');
  ProcVarCast(glFragmentLightModelfSGIX) := LoadExtensionFunction('glFragmentLightModelfSGIX');
  ProcVarCast(glFragmentLightModelfvSGIX) := LoadExtensionFunction('glFragmentLightModelfvSGIX');
  ProcVarCast(glFragmentLightModeliSGIX) := LoadExtensionFunction('glFragmentLightModeliSGIX');
  ProcVarCast(glFragmentLightModelivSGIX) := LoadExtensionFunction('glFragmentLightModelivSGIX');
  ProcVarCast(glFragmentMaterialfSGIX) := LoadExtensionFunction('glFragmentMaterialfSGIX');
  ProcVarCast(glFragmentMaterialfvSGIX) := LoadExtensionFunction('glFragmentMaterialfvSGIX');
  ProcVarCast(glFragmentMaterialiSGIX) := LoadExtensionFunction('glFragmentMaterialiSGIX');
  ProcVarCast(glFragmentMaterialivSGIX) := LoadExtensionFunction('glFragmentMaterialivSGIX');
  ProcVarCast(glGetFragmentLightfvSGIX) := LoadExtensionFunction('glGetFragmentLightfvSGIX');
  ProcVarCast(glGetFragmentLightivSGIX) := LoadExtensionFunction('glGetFragmentLightivSGIX');
  ProcVarCast(glGetFragmentMaterialfvSGIX) := LoadExtensionFunction('glGetFragmentMaterialfvSGIX');
  ProcVarCast(glGetFragmentMaterialivSGIX) := LoadExtensionFunction('glGetFragmentMaterialivSGIX');
  ProcVarCast(glLightEnviSGIX) := LoadExtensionFunction('glLightEnviSGIX');

   { GL_EXT_draw_range_elements }
  ProcVarCast(glDrawRangeElementsEXT) := LoadExtensionFunction('glDrawRangeElementsEXT');

   { GL_EXT_light_texture }
  ProcVarCast(glApplyTextureEXT) := LoadExtensionFunction('glApplyTextureEXT');
  ProcVarCast(glTextureLightEXT) := LoadExtensionFunction('glTextureLightEXT');
  ProcVarCast(glTextureMaterialEXT) := LoadExtensionFunction('glTextureMaterialEXT');

   { GL_SGIX_async }
  ProcVarCast(glAsyncMarkerSGIX) := LoadExtensionFunction('glAsyncMarkerSGIX');
  ProcVarCast(glFinishAsyncSGIX) := LoadExtensionFunction('glFinishAsyncSGIX');
  ProcVarCast(glPollAsyncSGIX) := LoadExtensionFunction('glPollAsyncSGIX');
  ProcVarCast(glGenAsyncMarkersSGIX) := LoadExtensionFunction('glGenAsyncMarkersSGIX');
  ProcVarCast(glDeleteAsyncMarkersSGIX) := LoadExtensionFunction('glDeleteAsyncMarkersSGIX');
  ProcVarCast(glIsAsyncMarkerSGIX) := LoadExtensionFunction('glIsAsyncMarkerSGIX');

   { GL_INTEL_parallel_arrays }
  ProcVarCast(glVertexPointervINTEL) := LoadExtensionFunction('glVertexPointervINTEL');
  ProcVarCast(glNormalPointervINTEL) := LoadExtensionFunction('glNormalPointervINTEL');
  ProcVarCast(glColorPointervINTEL) := LoadExtensionFunction('glColorPointervINTEL');
  ProcVarCast(glTexCoordPointervINTEL) := LoadExtensionFunction('glTexCoordPointervINTEL');

   { GL_EXT_pixel_transform }
  ProcVarCast(glPixelTransformParameteriEXT) := LoadExtensionFunction('glPixelTransformParameteriEXT');
  ProcVarCast(glPixelTransformParameterfEXT) := LoadExtensionFunction('glPixelTransformParameterfEXT');
  ProcVarCast(glPixelTransformParameterivEXT) := LoadExtensionFunction('glPixelTransformParameterivEXT');
  ProcVarCast(glPixelTransformParameterfvEXT) := LoadExtensionFunction('glPixelTransformParameterfvEXT');

   { GL_EXT_secondary_color }
  ProcVarCast(glSecondaryColor3bEXT) := LoadExtensionFunction('glSecondaryColor3bEXT');
  ProcVarCast(glSecondaryColor3bvEXT) := LoadExtensionFunction('glSecondaryColor3bvEXT');
  ProcVarCast(glSecondaryColor3dEXT) := LoadExtensionFunction('glSecondaryColor3dEXT');
  ProcVarCast(glSecondaryColor3dvEXT) := LoadExtensionFunction('glSecondaryColor3dvEXT');
  ProcVarCast(glSecondaryColor3fEXT) := LoadExtensionFunction('glSecondaryColor3fEXT');
  ProcVarCast(glSecondaryColor3fvEXT) := LoadExtensionFunction('glSecondaryColor3fvEXT');
  ProcVarCast(glSecondaryColor3iEXT) := LoadExtensionFunction('glSecondaryColor3iEXT');
  ProcVarCast(glSecondaryColor3ivEXT) := LoadExtensionFunction('glSecondaryColor3ivEXT');
  ProcVarCast(glSecondaryColor3sEXT) := LoadExtensionFunction('glSecondaryColor3sEXT');
  ProcVarCast(glSecondaryColor3svEXT) := LoadExtensionFunction('glSecondaryColor3svEXT');
  ProcVarCast(glSecondaryColor3ubEXT) := LoadExtensionFunction('glSecondaryColor3ubEXT');
  ProcVarCast(glSecondaryColor3ubvEXT) := LoadExtensionFunction('glSecondaryColor3ubvEXT');
  ProcVarCast(glSecondaryColor3uiEXT) := LoadExtensionFunction('glSecondaryColor3uiEXT');
  ProcVarCast(glSecondaryColor3uivEXT) := LoadExtensionFunction('glSecondaryColor3uivEXT');
  ProcVarCast(glSecondaryColor3usEXT) := LoadExtensionFunction('glSecondaryColor3usEXT');
  ProcVarCast(glSecondaryColor3usvEXT) := LoadExtensionFunction('glSecondaryColor3usvEXT');
  ProcVarCast(glSecondaryColorPointerEXT) := LoadExtensionFunction('glSecondaryColorPointerEXT');

   { GL_EXT_texture_perturb_normal }
  ProcVarCast(glTextureNormalEXT) := LoadExtensionFunction('glTextureNormalEXT');

   { GL_EXT_multi_draw_arrays }
  ProcVarCast(glMultiDrawArraysEXT) := LoadExtensionFunction('glMultiDrawArraysEXT');
  ProcVarCast(glMultiDrawElementsEXT) := LoadExtensionFunction('glMultiDrawElementsEXT');

   { GL_EXT_fog_coord }
  ProcVarCast(glFogCoordfEXT) := LoadExtensionFunction('glFogCoordfEXT');
  ProcVarCast(glFogCoordfvEXT) := LoadExtensionFunction('glFogCoordfvEXT');
  ProcVarCast(glFogCoorddEXT) := LoadExtensionFunction('glFogCoorddEXT');
  ProcVarCast(glFogCoorddvEXT) := LoadExtensionFunction('glFogCoorddvEXT');
  ProcVarCast(glFogCoordPointerEXT) := LoadExtensionFunction('glFogCoordPointerEXT');

   { GL_EXT_coordinate_frame }
  ProcVarCast(glTangent3bEXT) := LoadExtensionFunction('glTangent3bEXT');
  ProcVarCast(glTangent3bvEXT) := LoadExtensionFunction('glTangent3bvEXT');
  ProcVarCast(glTangent3dEXT) := LoadExtensionFunction('glTangent3dEXT');
  ProcVarCast(glTangent3dvEXT) := LoadExtensionFunction('glTangent3dvEXT');
  ProcVarCast(glTangent3fEXT) := LoadExtensionFunction('glTangent3fEXT');
  ProcVarCast(glTangent3fvEXT) := LoadExtensionFunction('glTangent3fvEXT');
  ProcVarCast(glTangent3iEXT) := LoadExtensionFunction('glTangent3iEXT');
  ProcVarCast(glTangent3ivEXT) := LoadExtensionFunction('glTangent3ivEXT');
  ProcVarCast(glTangent3sEXT) := LoadExtensionFunction('glTangent3sEXT');
  ProcVarCast(glTangent3svEXT) := LoadExtensionFunction('glTangent3svEXT');
  ProcVarCast(glBinormal3bEXT) := LoadExtensionFunction('glBinormal3bEXT');
  ProcVarCast(glBinormal3bvEXT) := LoadExtensionFunction('glBinormal3bvEXT');
  ProcVarCast(glBinormal3dEXT) := LoadExtensionFunction('glBinormal3dEXT');
  ProcVarCast(glBinormal3dvEXT) := LoadExtensionFunction('glBinormal3dvEXT');
  ProcVarCast(glBinormal3fEXT) := LoadExtensionFunction('glBinormal3fEXT');
  ProcVarCast(glBinormal3fvEXT) := LoadExtensionFunction('glBinormal3fvEXT');
  ProcVarCast(glBinormal3iEXT) := LoadExtensionFunction('glBinormal3iEXT');
  ProcVarCast(glBinormal3ivEXT) := LoadExtensionFunction('glBinormal3ivEXT');
  ProcVarCast(glBinormal3sEXT) := LoadExtensionFunction('glBinormal3sEXT');
  ProcVarCast(glBinormal3svEXT) := LoadExtensionFunction('glBinormal3svEXT');
  ProcVarCast(glTangentPointerEXT) := LoadExtensionFunction('glTangentPointerEXT');
  ProcVarCast(glBinormalPointerEXT) := LoadExtensionFunction('glBinormalPointerEXT');

   { GL_SUNX_constant_data }
  ProcVarCast(glFinishTextureSUNX) := LoadExtensionFunction('glFinishTextureSUNX');

   { GL_SUN_global_alpha }
  ProcVarCast(glGlobalAlphaFactorbSUN) := LoadExtensionFunction('glGlobalAlphaFactorbSUN');
  ProcVarCast(glGlobalAlphaFactorsSUN) := LoadExtensionFunction('glGlobalAlphaFactorsSUN');
  ProcVarCast(glGlobalAlphaFactoriSUN) := LoadExtensionFunction('glGlobalAlphaFactoriSUN');
  ProcVarCast(glGlobalAlphaFactorfSUN) := LoadExtensionFunction('glGlobalAlphaFactorfSUN');
  ProcVarCast(glGlobalAlphaFactordSUN) := LoadExtensionFunction('glGlobalAlphaFactordSUN');
  ProcVarCast(glGlobalAlphaFactorubSUN) := LoadExtensionFunction('glGlobalAlphaFactorubSUN');
  ProcVarCast(glGlobalAlphaFactorusSUN) := LoadExtensionFunction('glGlobalAlphaFactorusSUN');
  ProcVarCast(glGlobalAlphaFactoruiSUN) := LoadExtensionFunction('glGlobalAlphaFactoruiSUN');

   { GL_SUN_triangle_list }
  ProcVarCast(glReplacementCodeuiSUN) := LoadExtensionFunction('glReplacementCodeuiSUN');
  ProcVarCast(glReplacementCodeusSUN) := LoadExtensionFunction('glReplacementCodeusSUN');
  ProcVarCast(glReplacementCodeubSUN) := LoadExtensionFunction('glReplacementCodeubSUN');
  ProcVarCast(glReplacementCodeuivSUN) := LoadExtensionFunction('glReplacementCodeuivSUN');
  ProcVarCast(glReplacementCodeusvSUN) := LoadExtensionFunction('glReplacementCodeusvSUN');
  ProcVarCast(glReplacementCodeubvSUN) := LoadExtensionFunction('glReplacementCodeubvSUN');
  ProcVarCast(glReplacementCodePointerSUN) := LoadExtensionFunction('glReplacementCodePointerSUN');

   { GL_SUN_vertex }
  ProcVarCast(glColor4ubVertex2fSUN) := LoadExtensionFunction('glColor4ubVertex2fSUN');
  ProcVarCast(glColor4ubVertex2fvSUN) := LoadExtensionFunction('glColor4ubVertex2fvSUN');
  ProcVarCast(glColor4ubVertex3fSUN) := LoadExtensionFunction('glColor4ubVertex3fSUN');
  ProcVarCast(glColor4ubVertex3fvSUN) := LoadExtensionFunction('glColor4ubVertex3fvSUN');
  ProcVarCast(glColor3fVertex3fSUN) := LoadExtensionFunction('glColor3fVertex3fSUN');
  ProcVarCast(glColor3fVertex3fvSUN) := LoadExtensionFunction('glColor3fVertex3fvSUN');
  ProcVarCast(glNormal3fVertex3fSUN) := LoadExtensionFunction('glNormal3fVertex3fSUN');
  ProcVarCast(glNormal3fVertex3fvSUN) := LoadExtensionFunction('glNormal3fVertex3fvSUN');
  ProcVarCast(glColor4fNormal3fVertex3fSUN) := LoadExtensionFunction('glColor4fNormal3fVertex3fSUN');
  ProcVarCast(glColor4fNormal3fVertex3fvSUN) := LoadExtensionFunction('glColor4fNormal3fVertex3fvSUN');
  ProcVarCast(glTexCoord2fVertex3fSUN) := LoadExtensionFunction('glTexCoord2fVertex3fSUN');
  ProcVarCast(glTexCoord2fVertex3fvSUN) := LoadExtensionFunction('glTexCoord2fVertex3fvSUN');
  ProcVarCast(glTexCoord4fVertex4fSUN) := LoadExtensionFunction('glTexCoord4fVertex4fSUN');
  ProcVarCast(glTexCoord4fVertex4fvSUN) := LoadExtensionFunction('glTexCoord4fVertex4fvSUN');
  ProcVarCast(glTexCoord2fColor4ubVertex3fSUN) := LoadExtensionFunction('glTexCoord2fColor4ubVertex3fSUN');
  ProcVarCast(glTexCoord2fColor4ubVertex3fvSUN) := LoadExtensionFunction('glTexCoord2fColor4ubVertex3fvSUN');
  ProcVarCast(glTexCoord2fColor3fVertex3fSUN) := LoadExtensionFunction('glTexCoord2fColor3fVertex3fSUN');
  ProcVarCast(glTexCoord2fColor3fVertex3fvSUN) := LoadExtensionFunction('glTexCoord2fColor3fVertex3fvSUN');
  ProcVarCast(glTexCoord2fNormal3fVertex3fSUN) := LoadExtensionFunction('glTexCoord2fNormal3fVertex3fSUN');
  ProcVarCast(glTexCoord2fNormal3fVertex3fvSUN) := LoadExtensionFunction('glTexCoord2fNormal3fVertex3fvSUN');
  ProcVarCast(glTexCoord2fColor4fNormal3fVertex3fSUN) := LoadExtensionFunction('glTexCoord2fColor4fNormal3fVertex3fSUN');
  ProcVarCast(glTexCoord2fColor4fNormal3fVertex3fvSUN) := LoadExtensionFunction('glTexCoord2fColor4fNormal3fVertex3fvSUN');
  ProcVarCast(glTexCoord4fColor4fNormal3fVertex4fSUN) := LoadExtensionFunction('glTexCoord4fColor4fNormal3fVertex4fSUN');
  ProcVarCast(glTexCoord4fColor4fNormal3fVertex4fvSUN) := LoadExtensionFunction('glTexCoord4fColor4fNormal3fVertex4fvSUN');
  ProcVarCast(glReplacementCodeuiVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiVertex3fSUN');
  ProcVarCast(glReplacementCodeuiVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiColor4ubVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiColor4ubVertex3fSUN');
  ProcVarCast(glReplacementCodeuiColor4ubVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiColor4ubVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiColor3fVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiColor3fVertex3fSUN');
  ProcVarCast(glReplacementCodeuiColor3fVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiColor3fVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiNormal3fVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiNormal3fVertex3fSUN');
  ProcVarCast(glReplacementCodeuiNormal3fVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiNormal3fVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiColor4fNormal3fVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiColor4fNormal3fVertex3fSUN');
  ProcVarCast(glReplacementCodeuiColor4fNormal3fVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiColor4fNormal3fVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiTexCoord2fVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiTexCoord2fVertex3fSUN');
  ProcVarCast(glReplacementCodeuiTexCoord2fVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiTexCoord2fVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN');
  ProcVarCast(glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN');
  ProcVarCast(glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN) := LoadExtensionFunction('glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN');
  ProcVarCast(glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN) := LoadExtensionFunction('glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN');

   { GL_EXT_blend_func_separate }
  ProcVarCast(glBlendFuncSeparateEXT) := LoadExtensionFunction('glBlendFuncSeparateEXT');

   { GL_EXT_vertex_weighting }
  ProcVarCast(glVertexWeightfEXT) := LoadExtensionFunction('glVertexWeightfEXT');
  ProcVarCast(glVertexWeightfvEXT) := LoadExtensionFunction('glVertexWeightfvEXT');
  ProcVarCast(glVertexWeightPointerEXT) := LoadExtensionFunction('glVertexWeightPointerEXT');

   { GL_NV_vertex_array_range }
  ProcVarCast(glFlushVertexArrayRangeNV) := LoadExtensionFunction('glFlushVertexArrayRangeNV');
  ProcVarCast(glVertexArrayRangeNV) := LoadExtensionFunction('glVertexArrayRangeNV');
  ProcVarCast(wglAllocateMemoryNV) := LoadExtensionFunction('wglAllocateMemoryNV');
  ProcVarCast(wglFreeMemoryNV) := LoadExtensionFunction('wglFreeMemoryNV');

   { GL_NV_register_combiners }
  ProcVarCast(glCombinerParameterfvNV) := LoadExtensionFunction('glCombinerParameterfvNV');
  ProcVarCast(glCombinerParameterfNV) := LoadExtensionFunction('glCombinerParameterfNV');
  ProcVarCast(glCombinerParameterivNV) := LoadExtensionFunction('glCombinerParameterivNV');
  ProcVarCast(glCombinerParameteriNV) := LoadExtensionFunction('glCombinerParameteriNV');
  ProcVarCast(glCombinerInputNV) := LoadExtensionFunction('glCombinerInputNV');
  ProcVarCast(glCombinerOutputNV) := LoadExtensionFunction('glCombinerOutputNV');
  ProcVarCast(glFinalCombinerInputNV) := LoadExtensionFunction('glFinalCombinerInputNV');
  ProcVarCast(glGetCombinerInputParameterfvNV) := LoadExtensionFunction('glGetCombinerInputParameterfvNV');
  ProcVarCast(glGetCombinerInputParameterivNV) := LoadExtensionFunction('glGetCombinerInputParameterivNV');
  ProcVarCast(glGetCombinerOutputParameterfvNV) := LoadExtensionFunction('glGetCombinerOutputParameterfvNV');
  ProcVarCast(glGetCombinerOutputParameterivNV) := LoadExtensionFunction('glGetCombinerOutputParameterivNV');
  ProcVarCast(glGetFinalCombinerInputParameterfvNV) := LoadExtensionFunction('glGetFinalCombinerInputParameterfvNV');
  ProcVarCast(glGetFinalCombinerInputParameterivNV) := LoadExtensionFunction('glGetFinalCombinerInputParameterivNV');

   { GL_MESA_resize_buffers }
  ProcVarCast(glResizeBuffersMESA) := LoadExtensionFunction('glResizeBuffersMESA');

   { GL_MESA_window_pos }
  ProcVarCast(glWindowPos2dMESA) := LoadExtensionFunction('glWindowPos2dMESA');
  ProcVarCast(glWindowPos2dvMESA) := LoadExtensionFunction('glWindowPos2dvMESA');
  ProcVarCast(glWindowPos2fMESA) := LoadExtensionFunction('glWindowPos2fMESA');
  ProcVarCast(glWindowPos2fvMESA) := LoadExtensionFunction('glWindowPos2fvMESA');
  ProcVarCast(glWindowPos2iMESA) := LoadExtensionFunction('glWindowPos2iMESA');
  ProcVarCast(glWindowPos2ivMESA) := LoadExtensionFunction('glWindowPos2ivMESA');
  ProcVarCast(glWindowPos2sMESA) := LoadExtensionFunction('glWindowPos2sMESA');
  ProcVarCast(glWindowPos2svMESA) := LoadExtensionFunction('glWindowPos2svMESA');
  ProcVarCast(glWindowPos3dMESA) := LoadExtensionFunction('glWindowPos3dMESA');
  ProcVarCast(glWindowPos3dvMESA) := LoadExtensionFunction('glWindowPos3dvMESA');
  ProcVarCast(glWindowPos3fMESA) := LoadExtensionFunction('glWindowPos3fMESA');
  ProcVarCast(glWindowPos3fvMESA) := LoadExtensionFunction('glWindowPos3fvMESA');
  ProcVarCast(glWindowPos3iMESA) := LoadExtensionFunction('glWindowPos3iMESA');
  ProcVarCast(glWindowPos3ivMESA) := LoadExtensionFunction('glWindowPos3ivMESA');
  ProcVarCast(glWindowPos3sMESA) := LoadExtensionFunction('glWindowPos3sMESA');
  ProcVarCast(glWindowPos3svMESA) := LoadExtensionFunction('glWindowPos3svMESA');
  ProcVarCast(glWindowPos4dMESA) := LoadExtensionFunction('glWindowPos4dMESA');
  ProcVarCast(glWindowPos4dvMESA) := LoadExtensionFunction('glWindowPos4dvMESA');
  ProcVarCast(glWindowPos4fMESA) := LoadExtensionFunction('glWindowPos4fMESA');
  ProcVarCast(glWindowPos4fvMESA) := LoadExtensionFunction('glWindowPos4fvMESA');
  ProcVarCast(glWindowPos4iMESA) := LoadExtensionFunction('glWindowPos4iMESA');
  ProcVarCast(glWindowPos4ivMESA) := LoadExtensionFunction('glWindowPos4ivMESA');
  ProcVarCast(glWindowPos4sMESA) := LoadExtensionFunction('glWindowPos4sMESA');
  ProcVarCast(glWindowPos4svMESA) := LoadExtensionFunction('glWindowPos4svMESA');

   { GL_IBM_multimode_draw_arrays }
  ProcVarCast(glMultiModeDrawArraysIBM) := LoadExtensionFunction('glMultiModeDrawArraysIBM');
  ProcVarCast(glMultiModeDrawElementsIBM) := LoadExtensionFunction('glMultiModeDrawElementsIBM');

   { GL_IBM_vertex_array_lists }
  ProcVarCast(glColorPointerListIBM) := LoadExtensionFunction('glColorPointerListIBM');
  ProcVarCast(glSecondaryColorPointerListIBM) := LoadExtensionFunction('glSecondaryColorPointerListIBM');
  ProcVarCast(glEdgeFlagPointerListIBM) := LoadExtensionFunction('glEdgeFlagPointerListIBM');
  ProcVarCast(glFogCoordPointerListIBM) := LoadExtensionFunction('glFogCoordPointerListIBM');
  ProcVarCast(glIndexPointerListIBM) := LoadExtensionFunction('glIndexPointerListIBM');
  ProcVarCast(glNormalPointerListIBM) := LoadExtensionFunction('glNormalPointerListIBM');
  ProcVarCast(glTexCoordPointerListIBM) := LoadExtensionFunction('glTexCoordPointerListIBM');
  ProcVarCast(glVertexPointerListIBM) := LoadExtensionFunction('glVertexPointerListIBM');

   { GL_3DFX_tbuffer }
  ProcVarCast(glTbufferMask3DFX) := LoadExtensionFunction('glTbufferMask3DFX');

   { GL_EXT_multisample }
  ProcVarCast(glSampleMaskEXT) := LoadExtensionFunction('glSampleMaskEXT');
  ProcVarCast(glSamplePatternEXT) := LoadExtensionFunction('glSamplePatternEXT');

   { GL_SGIS_texture_color_mask }
  ProcVarCast(glTextureColorMaskSGIS) := LoadExtensionFunction('glTextureColorMaskSGIS');

   { GL_SGIX_igloo_interface }
  ProcVarCast(glIglooInterfaceSGIX) := LoadExtensionFunction('glIglooInterfaceSGIX');
  ...
  ProcVarCast(gluDeleteNurbsTessellatorEXT) := LoadExtensionFunction('gluDeleteNurbsTessellatorEXT');
   ...
   { GL_NV_vertex_program }
  ProcVarCast(glAreProgramsResidentNV) := LoadExtensionFunction('glAreProgramsResidentNV');
  ProcVarCast(glBindProgramNV) := LoadExtensionFunction('glBindProgramNV');
  ProcVarCast(glDeleteProgramsNV) := LoadExtensionFunction('glDeleteProgramsNV');
  ProcVarCast(glExecuteProgramNV) := LoadExtensionFunction('glExecuteProgramNV');
  ProcVarCast(glGenProgramsNV) := LoadExtensionFunction('glGenProgramsNV');
  ProcVarCast(glGetProgramParameterdvNV) := LoadExtensionFunction('glGetProgramParameterdvNV');
  ProcVarCast(glGetProgramParameterfvNV) := LoadExtensionFunction('glGetProgramParameterfvNV');
  ProcVarCast(glGetProgramivNV) := LoadExtensionFunction('glGetProgramivNV');
  ProcVarCast(glGetProgramStringNV) := LoadExtensionFunction('glGetProgramStringNV');
  ProcVarCast(glGetTrackMatrixivNV) := LoadExtensionFunction('glGetTrackMatrixivNV');
  ProcVarCast(glGetVertexAttribdvNV) := LoadExtensionFunction('glGetVertexAttribdvNV');
  ProcVarCast(glGetVertexAttribfvNV) := LoadExtensionFunction('glGetVertexAttribfvNV');
  ProcVarCast(glGetVertexAttribivNV) := LoadExtensionFunction('glGetVertexAttribivNV');
  ProcVarCast(glGetVertexAttribPointervNV) := LoadExtensionFunction('glGetVertexAttribPointervNV');
  ProcVarCast(glIsProgramNV) := LoadExtensionFunction('glIsProgramNV');
  ProcVarCast(glLoadProgramNV) := LoadExtensionFunction('glLoadProgramNV');
  ProcVarCast(glProgramParameter4dNV) := LoadExtensionFunction('glProgramParameter4dNV');
  ProcVarCast(glProgramParameter4dvNV) := LoadExtensionFunction('glProgramParameter4dvNV');
  ProcVarCast(glProgramParameter4fNV) := LoadExtensionFunction('glProgramParameter4fNV');
  ProcVarCast(glProgramParameter4fvNV) := LoadExtensionFunction('glProgramParameter4fvNV');
  ProcVarCast(glProgramParameters4dvNV) := LoadExtensionFunction('glProgramParameters4dvNV');
  ProcVarCast(glProgramParameters4fvNV) := LoadExtensionFunction('glProgramParameters4fvNV');
  ProcVarCast(glRequestResidentProgramsNV) := LoadExtensionFunction('glRequestResidentProgramsNV');
  ProcVarCast(glTrackMatrixNV) := LoadExtensionFunction('glTrackMatrixNV');
  ProcVarCast(glVertexAttribPointerNV) := LoadExtensionFunction('glVertexAttribPointerNV');
  ProcVarCast(glVertexAttrib1dNV) := LoadExtensionFunction('glVertexAttrib1dNV');
  ProcVarCast(glVertexAttrib1dvNV) := LoadExtensionFunction('glVertexAttrib1dvNV');
  ProcVarCast(glVertexAttrib1fNV) := LoadExtensionFunction('glVertexAttrib1fNV');
  ProcVarCast(glVertexAttrib1fvNV) := LoadExtensionFunction('glVertexAttrib1fvNV');
  ProcVarCast(glVertexAttrib1sNV) := LoadExtensionFunction('glVertexAttrib1sNV');
  ProcVarCast(glVertexAttrib1svNV) := LoadExtensionFunction('glVertexAttrib1svNV');
  ProcVarCast(glVertexAttrib2dNV) := LoadExtensionFunction('glVertexAttrib2dNV');
  ProcVarCast(glVertexAttrib2dvNV) := LoadExtensionFunction('glVertexAttrib2dvNV');
  ProcVarCast(glVertexAttrib2fNV) := LoadExtensionFunction('glVertexAttrib2fNV');
  ProcVarCast(glVertexAttrib2fvNV) := LoadExtensionFunction('glVertexAttrib2fvNV');
  ProcVarCast(glVertexAttrib2sNV) := LoadExtensionFunction('glVertexAttrib2sNV');
  ProcVarCast(glVertexAttrib2svNV) := LoadExtensionFunction('glVertexAttrib2svNV');
  ProcVarCast(glVertexAttrib3dNV) := LoadExtensionFunction('glVertexAttrib3dNV');
  ProcVarCast(glVertexAttrib3dvNV) := LoadExtensionFunction('glVertexAttrib3dvNV');
  ProcVarCast(glVertexAttrib3fNV) := LoadExtensionFunction('glVertexAttrib3fNV');
  ProcVarCast(glVertexAttrib3fvNV) := LoadExtensionFunction('glVertexAttrib3fvNV');
  ProcVarCast(glVertexAttrib3sNV) := LoadExtensionFunction('glVertexAttrib3sNV');
  ProcVarCast(glVertexAttrib3svNV) := LoadExtensionFunction('glVertexAttrib3svNV');
  ProcVarCast(glVertexAttrib4dNV) := LoadExtensionFunction('glVertexAttrib4dNV');
  ProcVarCast(glVertexAttrib4dvNV) := LoadExtensionFunction('glVertexAttrib4dvNV');
  ProcVarCast(glVertexAttrib4fNV) := LoadExtensionFunction('glVertexAttrib4fNV');
  ProcVarCast(glVertexAttrib4fvNV) := LoadExtensionFunction('glVertexAttrib4fvNV');
  ProcVarCast(glVertexAttrib4sNV) := LoadExtensionFunction('glVertexAttrib4sNV');
  ProcVarCast(glVertexAttrib4svNV) := LoadExtensionFunction('glVertexAttrib4svNV');
  ProcVarCast(glVertexAttrib4ubvNV) := LoadExtensionFunction('glVertexAttrib4ubvNV');
  ProcVarCast(glVertexAttribs1dvNV) := LoadExtensionFunction('glVertexAttribs1dvNV');
  ProcVarCast(glVertexAttribs1fvNV) := LoadExtensionFunction('glVertexAttribs1fvNV');
  ProcVarCast(glVertexAttribs1svNV) := LoadExtensionFunction('glVertexAttribs1svNV');
  ProcVarCast(glVertexAttribs2dvNV) := LoadExtensionFunction('glVertexAttribs2dvNV');
  ProcVarCast(glVertexAttribs2fvNV) := LoadExtensionFunction('glVertexAttribs2fvNV');
  ProcVarCast(glVertexAttribs2svNV) := LoadExtensionFunction('glVertexAttribs2svNV');
  ProcVarCast(glVertexAttribs3dvNV) := LoadExtensionFunction('glVertexAttribs3dvNV');
  ProcVarCast(glVertexAttribs3fvNV) := LoadExtensionFunction('glVertexAttribs3fvNV');
  ProcVarCast(glVertexAttribs3svNV) := LoadExtensionFunction('glVertexAttribs3svNV');
  ProcVarCast(glVertexAttribs4dvNV) := LoadExtensionFunction('glVertexAttribs4dvNV');
  ...
  ProcVarCast(glXWaitVideoSyncSGI) := LoadExtensionFunction('glXWaitVideoSyncSGI');
  ProcVarCast(glXFreeContextEXT) := LoadExtensionFunction('glXFreeContextEXT');
  ProcVarCast(glXGetContextIDEXT) := LoadExtensionFunction('glXGetContextIDEXT');
  ProcVarCast(glXGetCurrentDisplayEXT) := LoadExtensionFunction('glXGetCurrentDisplayEXT');
  ProcVarCast(glXImportContextEXT) := LoadExtensionFunction('glXImportContextEXT');
  ProcVarCast(glXQueryContextInfoEXT) := LoadExtensionFunction('glXQueryContextInfoEXT');
  ProcVarCast(glXCopySubBufferMESA) := LoadExtensionFunction('glXCopySubBufferMESA');
  ProcVarCast(glXCreateGLXPixmapMESA) := LoadExtensionFunction('glXCreateGLXPixmapMESA');
  ProcVarCast(glXReleaseBuffersMESA) := LoadExtensionFunction('glXReleaseBuffersMESA');
  ProcVarCast(glXSet3DfxModeMESA) := LoadExtensionFunction('glXSet3DfxModeMESA');
  {$endif}
