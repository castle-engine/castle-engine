...
{ @abstract(The @link(TVRMLOpenGLRenderer) class, responsible for
  ...
  @unorderedList(
    ...
    @item(glFrontFace is assumed to be CCW (OpenGL default) but not manipulated
      ...
      and example program
      @code(kambi_vrml_game_engine/vrml/opengl/examples/plane_mirror_and_shadow.pasprogram).
...
type
  ...
  public
    ...
    { Use this to render pure geometry, without any colors, materials, etc.
      ...
      see kambi_vrml_game_engine/vrml/opengl/examples/plane_projected_shadow_demo.pasprogram.
