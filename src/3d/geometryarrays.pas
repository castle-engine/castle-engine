...
type
  ...
  { Texture coordinate generation methods.
    ...
    [http://castle-engine.sourceforge.net/kambi_vrml_extensions.php#section_ext_tex_coord_worldspace] and
    [http://castle-engine.sourceforge.net/kambi_vrml_extensions.php#section_ext_tex_coord_bounds].
    We also support ProjectedTextureCoordinate, see
    [http://castle-engine.sourceforge.net/kambi_vrml_extensions_shadow_maps.php#section_ext_texture_gen_projective].
