...
{ Operations on files and URLs.

  Notes about reading and writing resources
  in a cross-platform applications using Castle Game Engine:
  ...
  @unorderedList(
    ...
    @item(
      Use "castle-config:/xxx" for all URLs where you save or load
    ...
    @item(
      ...
      It is defined in the standard SysUtils unit for FPC,
      ...
      If you follow the standard new project template, the auto-generated
      CastleAutoGenerated unit will assign it for you.
    )
    ...
    @item(
      ...
      It nicely works with URLs, has support for the Android "assets",
      has support for CGE "castle-data:/" URLs,
      and it has more comfortable API (e.g. searching recursively
