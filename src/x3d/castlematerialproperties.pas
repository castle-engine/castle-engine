...
procedure TMaterialProperties.TAutoGeneratedTextures.LoadImageEvent(
  ...
  begin
    ...
    if GLFeatures = nil then
      WritelnWarning('MaterialProperties', 'Cannot determine whether to use GPU compressed (and potentially downscaled) version for ' + URL + ' because the image is loaded before GPU capabilities are known') else
