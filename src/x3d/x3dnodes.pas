...
var
  ...
  { Whether we detect loops in X3D routes.
    Should be left @true always, except to workaround some yet-to-be-fixed
    bugs on complicated X3D graphs generated by Spine importer on some models. }
  DetectX3DRouteLoops: boolean = true;
...
begin
  ...
  if (Time > LastEventTime) or not DetectX3DRouteLoops then
  begin
    LastEventTime := Time;
