...
type
  ...
  public
    ...
    function Texture(const Url: String; const OriginalPlatformsString: String; const CreateIfNotExists: Boolean): TTexture;
...
function TAutoGenerated.Texture(const Url: String; const OriginalPlatformsString: String; const CreateIfNotExists: Boolean): TTexture;
begin
  ...
  begin
    ...
    Result.Url := Url;
    Result.OriginalPlatforms := StrToPlatforms(OriginalPlatformsString);
    Textures.Add(Result);
  end else
    Result := nil;
end;
