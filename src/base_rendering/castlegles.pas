...
procedure LoadGLES(const Lib: string; const AltLibName: string = '');
  ...
  function MyGetProcAddress(const ProcName: PAnsiChar): pointer;
  begin
    Assert(GLESLib <> nil);
    result := GLESLib.Symbol(ProcName);
...
begin
  ...
  { OpenGL ES 2.0 APIs }
  pointer(glActiveTexture) := MyGetProcAddress('glActiveTexture');
  pointer(glAttachShader) := MyGetProcAddress('glAttachShader');
  pointer(glBindAttribLocation) := MyGetProcAddress('glBindAttribLocation');
  pointer(glBindBuffer) := MyGetProcAddress('glBindBuffer');
  pointer(glBindFramebuffer) := MyGetProcAddress('glBindFramebuffer');
  pointer(glBindRenderbuffer) := MyGetProcAddress('glBindRenderbuffer');
  pointer(glBindTexture) := MyGetProcAddress('glBindTexture');
  pointer(glBlendColor) := MyGetProcAddress('glBlendColor');
  pointer(glBlendEquation) := MyGetProcAddress('glBlendEquation');
  pointer(glBlendEquationSeparate) := MyGetProcAddress('glBlendEquationSeparate');
  pointer(glBlendFunc) := MyGetProcAddress('glBlendFunc');
  pointer(glBlendFuncSeparate) := MyGetProcAddress('glBlendFuncSeparate');
  pointer(glBufferData) := MyGetProcAddress('glBufferData');
  pointer(glBufferSubData) := MyGetProcAddress('glBufferSubData');
  pointer(glCheckFramebufferStatus) := MyGetProcAddress('glCheckFramebufferStatus');
  pointer(glClear) := MyGetProcAddress('glClear');
  pointer(glClearColor) := MyGetProcAddress('glClearColor');
  pointer(glClearDepthf) := MyGetProcAddress('glClearDepthf');
  pointer(glClearStencil) := MyGetProcAddress('glClearStencil');
  pointer(glColorMask) := MyGetProcAddress('glColorMask');
  pointer(glCompileShader) := MyGetProcAddress('glCompileShader');
  pointer(glCompressedTexImage2D) := MyGetProcAddress('glCompressedTexImage2D');
  pointer(glCompressedTexSubImage2D) := MyGetProcAddress('glCompressedTexSubImage2D');
  pointer(glCopyTexImage2D) := MyGetProcAddress('glCopyTexImage2D');
  pointer(glCopyTexSubImage2D) := MyGetProcAddress('glCopyTexSubImage2D');
  pointer(glCreateProgram) := MyGetProcAddress('glCreateProgram');
  pointer(glCreateShader) := MyGetProcAddress('glCreateShader');
  pointer(glCullFace) := MyGetProcAddress('glCullFace');
  pointer(glDeleteBuffers) := MyGetProcAddress('glDeleteBuffers');
  pointer(glDeleteFramebuffers) := MyGetProcAddress('glDeleteFramebuffers');
  pointer(glDeleteProgram) := MyGetProcAddress('glDeleteProgram');
  pointer(glDeleteRenderbuffers) := MyGetProcAddress('glDeleteRenderbuffers');
  pointer(glDeleteShader) := MyGetProcAddress('glDeleteShader');
  pointer(glDeleteTextures) := MyGetProcAddress('glDeleteTextures');
  pointer(glDepthFunc) := MyGetProcAddress('glDepthFunc');
  pointer(glDepthMask) := MyGetProcAddress('glDepthMask');
  pointer(glDepthRangef) := MyGetProcAddress('glDepthRangef');
  pointer(glDetachShader) := MyGetProcAddress('glDetachShader');
  pointer(glDisable) := MyGetProcAddress('glDisable');
  pointer(glDisableVertexAttribArray) := MyGetProcAddress('glDisableVertexAttribArray');
  pointer(glDrawArrays) := MyGetProcAddress('glDrawArrays');
  pointer(glDrawElements) := MyGetProcAddress('glDrawElements');
  pointer(glEnable) := MyGetProcAddress('glEnable');
  pointer(glEnableVertexAttribArray) := MyGetProcAddress('glEnableVertexAttribArray');
  pointer(glFinish) := MyGetProcAddress('glFinish');
  pointer(glFlush) := MyGetProcAddress('glFlush');
  pointer(glFramebufferRenderbuffer) := MyGetProcAddress('glFramebufferRenderbuffer');
  pointer(glFramebufferTexture2D) := MyGetProcAddress('glFramebufferTexture2D');
  pointer(glFrontFace) := MyGetProcAddress('glFrontFace');
  pointer(glGenBuffers) := MyGetProcAddress('glGenBuffers');
  pointer(glGenerateMipmap) := MyGetProcAddress('glGenerateMipmap');
  pointer(glGenFramebuffers) := MyGetProcAddress('glGenFramebuffers');
  pointer(glGenRenderbuffers) := MyGetProcAddress('glGenRenderbuffers');
  pointer(glGenTextures) := MyGetProcAddress('glGenTextures');
  pointer(glGetActiveAttrib) := MyGetProcAddress('glGetActiveAttrib');
  pointer(glGetActiveUniform) := MyGetProcAddress('glGetActiveUniform');
  pointer(glGetAttachedShaders) := MyGetProcAddress('glGetAttachedShaders');
  pointer(glGetAttribLocation) := MyGetProcAddress('glGetAttribLocation');
  pointer(glGetBooleanv) := MyGetProcAddress('glGetBooleanv');
  pointer(glGetBufferParameteriv) := MyGetProcAddress('glGetBufferParameteriv');
  pointer(glGetError) := MyGetProcAddress('glGetError');
  pointer(glGetFloatv) := MyGetProcAddress('glGetFloatv');
  pointer(glGetFramebufferAttachmentParameteriv) := MyGetProcAddress('glGetFramebufferAttachmentParameteriv');
  pointer(glGetIntegerv) := MyGetProcAddress('glGetIntegerv');
  pointer(glGetProgramiv) := MyGetProcAddress('glGetProgramiv');
  pointer(glGetProgramInfoLog) := MyGetProcAddress('glGetProgramInfoLog');
  pointer(glGetRenderbufferParameteriv) := MyGetProcAddress('glGetRenderbufferParameteriv');
  pointer(glGetShaderiv) := MyGetProcAddress('glGetShaderiv');
  pointer(glGetShaderInfoLog) := MyGetProcAddress('glGetShaderInfoLog');
  pointer(glGetShaderPrecisionFormat) := MyGetProcAddress('glGetShaderPrecisionFormat');
  pointer(glGetShaderSource) := MyGetProcAddress('glGetShaderSource');
  pointer(glGetString) := MyGetProcAddress('glGetString');
  pointer(glGetTexParameterfv) := MyGetProcAddress('glGetTexParameterfv');
  pointer(glGetTexParameteriv) := MyGetProcAddress('glGetTexParameteriv');
  pointer(glGetUniformfv) := MyGetProcAddress('glGetUniformfv');
  pointer(glGetUniformiv) := MyGetProcAddress('glGetUniformiv');
  pointer(glGetUniformLocation) := MyGetProcAddress('glGetUniformLocation');
  pointer(glGetVertexAttribfv) := MyGetProcAddress('glGetVertexAttribfv');
  pointer(glGetVertexAttribiv) := MyGetProcAddress('glGetVertexAttribiv');
  pointer(glGetVertexAttribPointerv) := MyGetProcAddress('glGetVertexAttribPointerv');
  pointer(glHint) := MyGetProcAddress('glHint');
  pointer(glIsBuffer) := MyGetProcAddress('glIsBuffer');
  pointer(glIsEnabled) := MyGetProcAddress('glIsEnabled');
  pointer(glIsFramebuffer) := MyGetProcAddress('glIsFramebuffer');
  pointer(glIsProgram) := MyGetProcAddress('glIsProgram');
  pointer(glIsRenderbuffer) := MyGetProcAddress('glIsRenderbuffer');
  pointer(glIsShader) := MyGetProcAddress('glIsShader');
  pointer(glIsTexture) := MyGetProcAddress('glIsTexture');
  pointer(glLineWidth) := MyGetProcAddress('glLineWidth');
  pointer(glLinkProgram) := MyGetProcAddress('glLinkProgram');
  pointer(glPixelStorei) := MyGetProcAddress('glPixelStorei');
  pointer(glPolygonOffset) := MyGetProcAddress('glPolygonOffset');
  pointer(glReadPixels) := MyGetProcAddress('glReadPixels');
  pointer(glReleaseShaderCompiler) := MyGetProcAddress('glReleaseShaderCompiler');
  pointer(glRenderbufferStorage) := MyGetProcAddress('glRenderbufferStorage');
  pointer(glSampleCoverage) := MyGetProcAddress('glSampleCoverage');
  pointer(glScissor) := MyGetProcAddress('glScissor');
  pointer(glShaderBinary) := MyGetProcAddress('glShaderBinary');
  pointer(glShaderSource) := MyGetProcAddress('glShaderSource');
  pointer(glStencilFunc) := MyGetProcAddress('glStencilFunc');
  pointer(glStencilFuncSeparate) := MyGetProcAddress('glStencilFuncSeparate');
  pointer(glStencilMask) := MyGetProcAddress('glStencilMask');
  pointer(glStencilMaskSeparate) := MyGetProcAddress('glStencilMaskSeparate');
  pointer(glStencilOp) := MyGetProcAddress('glStencilOp');
  pointer(glStencilOpSeparate) := MyGetProcAddress('glStencilOpSeparate');
  pointer(glTexImage2D) := MyGetProcAddress('glTexImage2D');
  pointer(glTexParameterf) := MyGetProcAddress('glTexParameterf');
  pointer(glTexParameterfv) := MyGetProcAddress('glTexParameterfv');
  pointer(glTexParameteri) := MyGetProcAddress('glTexParameteri');
  pointer(glTexParameteriv) := MyGetProcAddress('glTexParameteriv');
  pointer(glTexSubImage2D) := MyGetProcAddress('glTexSubImage2D');
  pointer(glUniform1f) := MyGetProcAddress('glUniform1f');
  pointer(glUniform1fv) := MyGetProcAddress('glUniform1fv');
  pointer(glUniform1i) := MyGetProcAddress('glUniform1i');
  pointer(glUniform1iv) := MyGetProcAddress('glUniform1iv');
  pointer(glUniform2f) := MyGetProcAddress('glUniform2f');
  pointer(glUniform2fv) := MyGetProcAddress('glUniform2fv');
  pointer(glUniform2i) := MyGetProcAddress('glUniform2i');
  pointer(glUniform2iv) := MyGetProcAddress('glUniform2iv');
  pointer(glUniform3f) := MyGetProcAddress('glUniform3f');
  pointer(glUniform3fv) := MyGetProcAddress('glUniform3fv');
  pointer(glUniform3i) := MyGetProcAddress('glUniform3i');
  pointer(glUniform3iv) := MyGetProcAddress('glUniform3iv');
  pointer(glUniform4f) := MyGetProcAddress('glUniform4f');
  pointer(glUniform4fv) := MyGetProcAddress('glUniform4fv');
  pointer(glUniform4i) := MyGetProcAddress('glUniform4i');
  pointer(glUniform4iv) := MyGetProcAddress('glUniform4iv');
  pointer(glUniformMatrix2fv) := MyGetProcAddress('glUniformMatrix2fv');
  pointer(glUniformMatrix3fv) := MyGetProcAddress('glUniformMatrix3fv');
  pointer(glUniformMatrix4fv) := MyGetProcAddress('glUniformMatrix4fv');
  pointer(glUseProgram) := MyGetProcAddress('glUseProgram');
  pointer(glValidateProgram) := MyGetProcAddress('glValidateProgram');
  pointer(glVertexAttrib1f) := MyGetProcAddress('glVertexAttrib1f');
  pointer(glVertexAttrib1fv) := MyGetProcAddress('glVertexAttrib1fv');
  pointer(glVertexAttrib2f) := MyGetProcAddress('glVertexAttrib2f');
  pointer(glVertexAttrib2fv) := MyGetProcAddress('glVertexAttrib2fv');
  pointer(glVertexAttrib3f) := MyGetProcAddress('glVertexAttrib3f');
  pointer(glVertexAttrib3fv) := MyGetProcAddress('glVertexAttrib3fv');
  pointer(glVertexAttrib4f) := MyGetProcAddress('glVertexAttrib4f');
  pointer(glVertexAttrib4fv) := MyGetProcAddress('glVertexAttrib4fv');
  pointer(glVertexAttribPointer) := MyGetProcAddress('glVertexAttribPointer');
  pointer(glViewport) := MyGetProcAddress('glViewport');
  pointer(glEGLImageTargetTexture2DOES) := MyGetProcAddress('glEGLImageTargetTexture2DOES');
  pointer(glEGLImageTargetRenderbufferStorageOES) := MyGetProcAddress('glEGLImageTargetRenderbufferStorageOES');
  pointer(glGetProgramBinaryOES) := MyGetProcAddress('glGetProgramBinaryOES');
  pointer(glProgramBinaryOES) := MyGetProcAddress('glProgramBinaryOES');
  pointer(glMapBufferOES) := MyGetProcAddress('glMapBufferOES');
  pointer(glUnmapBufferOES) := MyGetProcAddress('glUnmapBufferOES');
  pointer(glGetBufferPointervOES) := MyGetProcAddress('glGetBufferPointervOES');
  pointer(glTexImage3DOES) := MyGetProcAddress('glTexImage3DOES');
  pointer(glTexSubImage3DOES) := MyGetProcAddress('glTexSubImage3DOES');
  pointer(glCopyTexSubImage3DOES) := MyGetProcAddress('glCopyTexSubImage3DOES');
  pointer(glCompressedTexImage3DOES) := MyGetProcAddress('glCompressedTexImage3DOES');
  pointer(glCompressedTexSubImage3DOES) := MyGetProcAddress('glCompressedTexSubImage3DOES');
  pointer(glFramebufferTexture3DOES) := MyGetProcAddress('glFramebufferTexture3DOES');
  pointer(glGetPerfMonitorGroupsAMD) := MyGetProcAddress('glGetPerfMonitorGroupsAMD');
  pointer(glGetPerfMonitorCountersAMD) := MyGetProcAddress('glGetPerfMonitorCountersAMD');
  pointer(glGetPerfMonitorGroupStringAMD) := MyGetProcAddress('glGetPerfMonitorGroupStringAMD');
  pointer(glGetPerfMonitorCounterStringAMD) := MyGetProcAddress('glGetPerfMonitorCounterStringAMD');
  pointer(glGetPerfMonitorCounterInfoAMD) := MyGetProcAddress('glGetPerfMonitorCounterInfoAMD');
  pointer(glGenPerfMonitorsAMD) := MyGetProcAddress('glGenPerfMonitorsAMD');
  pointer(glDeletePerfMonitorsAMD) := MyGetProcAddress('glDeletePerfMonitorsAMD');
  pointer(glSelectPerfMonitorCountersAMD) := MyGetProcAddress('glSelectPerfMonitorCountersAMD');
  pointer(glBeginPerfMonitorAMD) := MyGetProcAddress('glBeginPerfMonitorAMD');
  pointer(glEndPerfMonitorAMD) := MyGetProcAddress('glEndPerfMonitorAMD');
  pointer(glGetPerfMonitorCounterDataAMD) := MyGetProcAddress('glGetPerfMonitorCounterDataAMD');
  pointer(glDebugMessageCallback) := MyGetProcAddress('glDebugMessageCallback');
  pointer(glDebugMessageControl) := MyGetProcAddress('glDebugMessageControl');

  { OpenGL ES 3.0 APIs }
  pointer(glReadBuffer) := MyGetProcAddress('glReadBuffer');
  pointer(glDrawRangeElements) := MyGetProcAddress('glDrawRangeElements');
  pointer(glTexImage3D) := MyGetProcAddress('glTexImage3D');
  pointer(glTexSubImage3D) := MyGetProcAddress('glTexSubImage3D');
  pointer(glCopyTexSubImage3D) := MyGetProcAddress('glCopyTexSubImage3D');
  pointer(glCompressedTexImage3D) := MyGetProcAddress('glCompressedTexImage3D');
  pointer(glCompressedTexSubImage3D) := MyGetProcAddress('glCompressedTexSubImage3D');
  pointer(glGenQueries) := MyGetProcAddress('glGenQueries');
  pointer(glDeleteQueries) := MyGetProcAddress('glDeleteQueries');
  pointer(glIsQuery) := MyGetProcAddress('glIsQuery');
  pointer(glBeginQuery) := MyGetProcAddress('glBeginQuery');
  pointer(glEndQuery) := MyGetProcAddress('glEndQuery');
  pointer(glGetQueryiv) := MyGetProcAddress('glGetQueryiv');
  pointer(glGetQueryObjectuiv) := MyGetProcAddress('glGetQueryObjectuiv');
  pointer(glUnmapBuffer) := MyGetProcAddress('glUnmapBuffer');
  pointer(glGetBufferPointerv) := MyGetProcAddress('glGetBufferPointerv');
  pointer(glDrawBuffers) := MyGetProcAddress('glDrawBuffers');
  pointer(glUniformMatrix2x3fv) := MyGetProcAddress('glUniformMatrix2x3fv');
  pointer(glUniformMatrix3x2fv) := MyGetProcAddress('glUniformMatrix3x2fv');
  pointer(glUniformMatrix2x4fv) := MyGetProcAddress('glUniformMatrix2x4fv');
  pointer(glUniformMatrix4x2fv) := MyGetProcAddress('glUniformMatrix4x2fv');
  pointer(glUniformMatrix3x4fv) := MyGetProcAddress('glUniformMatrix3x4fv');
  pointer(glUniformMatrix4x3fv) := MyGetProcAddress('glUniformMatrix4x3fv');
  pointer(glBlitFramebuffer) := MyGetProcAddress('glBlitFramebuffer');
  pointer(glRenderbufferStorageMultisample) := MyGetProcAddress('glRenderbufferStorageMultisample');
  pointer(glFramebufferTextureLayer) := MyGetProcAddress('glFramebufferTextureLayer');
  pointer(glMapBufferRange) := MyGetProcAddress('glMapBufferRange');
  pointer(glFlushMappedBufferRange) := MyGetProcAddress('glFlushMappedBufferRange');
  pointer(glBindVertexArray) := MyGetProcAddress('glBindVertexArray');
  pointer(glDeleteVertexArrays) := MyGetProcAddress('glDeleteVertexArrays');
  pointer(glGenVertexArrays) := MyGetProcAddress('glGenVertexArrays');
  pointer(glIsVertexArray) := MyGetProcAddress('glIsVertexArray');
  pointer(glGetIntegeri_v) := MyGetProcAddress('glGetIntegeri_v');
  pointer(glBeginTransformFeedback) := MyGetProcAddress('glBeginTransformFeedback');
  pointer(glEndTransformFeedback) := MyGetProcAddress('glEndTransformFeedback');
  pointer(glBindBufferRange) := MyGetProcAddress('glBindBufferRange');
  pointer(glBindBufferBase) := MyGetProcAddress('glBindBufferBase');
  pointer(glTransformFeedbackVaryings) := MyGetProcAddress('glTransformFeedbackVaryings');
  pointer(glGetTransformFeedbackVarying) := MyGetProcAddress('glGetTransformFeedbackVarying');
  pointer(glVertexAttribIPointer) := MyGetProcAddress('glVertexAttribIPointer');
  pointer(glGetVertexAttribIiv) := MyGetProcAddress('glGetVertexAttribIiv');
  pointer(glGetVertexAttribIuiv) := MyGetProcAddress('glGetVertexAttribIuiv');
  pointer(glVertexAttribI4i) := MyGetProcAddress('glVertexAttribI4i');
  pointer(glVertexAttribI4ui) := MyGetProcAddress('glVertexAttribI4ui');
  pointer(glVertexAttribI4iv) := MyGetProcAddress('glVertexAttribI4iv');
  pointer(glVertexAttribI4uiv) := MyGetProcAddress('glVertexAttribI4uiv');
  pointer(glGetUniformuiv) := MyGetProcAddress('glGetUniformuiv');
  pointer(glGetFragDataLocation) := MyGetProcAddress('glGetFragDataLocation');
  pointer(glUniform1ui) := MyGetProcAddress('glUniform1ui');
  pointer(glUniform2ui) := MyGetProcAddress('glUniform2ui');
  pointer(glUniform3ui) := MyGetProcAddress('glUniform3ui');
  pointer(glUniform4ui) := MyGetProcAddress('glUniform4ui');
  pointer(glUniform1uiv) := MyGetProcAddress('glUniform1uiv');
  pointer(glUniform2uiv) := MyGetProcAddress('glUniform2uiv');
  pointer(glUniform3uiv) := MyGetProcAddress('glUniform3uiv');
  pointer(glUniform4uiv) := MyGetProcAddress('glUniform4uiv');
  pointer(glClearBufferiv) := MyGetProcAddress('glClearBufferiv');
  pointer(glClearBufferuiv) := MyGetProcAddress('glClearBufferuiv');
  pointer(glClearBufferfv) := MyGetProcAddress('glClearBufferfv');
  pointer(glClearBufferfi) := MyGetProcAddress('glClearBufferfi');
  pointer(glGetStringi) := MyGetProcAddress('glGetStringi');
  pointer(glCopyBufferSubData) := MyGetProcAddress('glCopyBufferSubData');
  pointer(glGetUniformIndices) := MyGetProcAddress('glGetUniformIndices');
  pointer(glGetActiveUniformsiv) := MyGetProcAddress('glGetActiveUniformsiv');
  pointer(glGetUniformBlockIndex) := MyGetProcAddress('glGetUniformBlockIndex');
  pointer(glGetActiveUniformBlockiv) := MyGetProcAddress('glGetActiveUniformBlockiv');
  pointer(glGetActiveUniformBlockName) := MyGetProcAddress('glGetActiveUniformBlockName');
  pointer(glUniformBlockBinding) := MyGetProcAddress('glUniformBlockBinding');
  pointer(glDrawArraysInstanced) := MyGetProcAddress('glDrawArraysInstanced');
  pointer(glDrawElementsInstanced) := MyGetProcAddress('glDrawElementsInstanced');
  pointer(glFenceSync) := MyGetProcAddress('glFenceSync');
  pointer(glIsSync) := MyGetProcAddress('glIsSync');
  pointer(glDeleteSync) := MyGetProcAddress('glDeleteSync');
  pointer(glClientWaitSync) := MyGetProcAddress('glClientWaitSync');
  pointer(glWaitSync) := MyGetProcAddress('glWaitSync');
  pointer(glGetInteger64v) := MyGetProcAddress('glGetInteger64v');
  pointer(glGetSynciv) := MyGetProcAddress('glGetSynciv');
  pointer(glGetInteger64i_v) := MyGetProcAddress('glGetInteger64i_v');
  pointer(glGetBufferParameteri64v) := MyGetProcAddress('glGetBufferParameteri64v');
  pointer(glGenSamplers) := MyGetProcAddress('glGenSamplers');
  pointer(glDeleteSamplers) := MyGetProcAddress('glDeleteSamplers');
  pointer(glIsSampler) := MyGetProcAddress('glIsSampler');
  pointer(glBindSampler) := MyGetProcAddress('glBindSampler');
  pointer(glSamplerParameteri) := MyGetProcAddress('glSamplerParameteri');
  pointer(glSamplerParameteriv) := MyGetProcAddress('glSamplerParameteriv');
  pointer(glSamplerParameterf) := MyGetProcAddress('glSamplerParameterf');
  pointer(glSamplerParameterfv) := MyGetProcAddress('glSamplerParameterfv');
  pointer(glGetSamplerParameteriv) := MyGetProcAddress('glGetSamplerParameteriv');
  pointer(glGetSamplerParameterfv) := MyGetProcAddress('glGetSamplerParameterfv');
  pointer(glVertexAttribDivisor) := MyGetProcAddress('glVertexAttribDivisor');
  pointer(glBindTransformFeedback) := MyGetProcAddress('glBindTransformFeedback');
  pointer(glDeleteTransformFeedbacks) := MyGetProcAddress('glDeleteTransformFeedbacks');
  pointer(glGenTransformFeedbacks) := MyGetProcAddress('glGenTransformFeedbacks');
  pointer(glIsTransformFeedback) := MyGetProcAddress('glIsTransformFeedback');
  pointer(glPauseTransformFeedback) := MyGetProcAddress('glPauseTransformFeedback');
  pointer(glResumeTransformFeedback) := MyGetProcAddress('glResumeTransformFeedback');
  pointer(glGetProgramBinary) := MyGetProcAddress('glGetProgramBinary');
  pointer(glProgramBinary) := MyGetProcAddress('glProgramBinary');
  pointer(glProgramParameteri) := MyGetProcAddress('glProgramParameteri');
  pointer(glInvalidateFramebuffer) := MyGetProcAddress('glInvalidateFramebuffer');
  pointer(glInvalidateSubFramebuffer) := MyGetProcAddress('glInvalidateSubFramebuffer');
  pointer(glTexStorage2D) := MyGetProcAddress('glTexStorage2D');
  pointer(glTexStorage3D) := MyGetProcAddress('glTexStorage3D');
  pointer(glGetInternalformativ) := MyGetProcAddress('glGetInternalformativ');
end;
