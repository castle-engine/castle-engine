...
begin
  ...
  begin
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} zlibVersionpchar, 'zlibVersion');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflate, 'deflate');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateEnd, 'deflateEnd');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflate, 'inflate');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateEnd, 'inflateEnd');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateSetDictionary, 'deflateSetDictionary');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateCopy, 'deflateCopy');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateReset, 'deflateReset');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateParams, 'deflateParams');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateSetDictionary, 'inflateSetDictionary');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateSync, 'inflateSync');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateReset, 'inflateReset');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} compress, 'compress');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} compress2, 'compress2');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} uncompress, 'uncompress');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzopen, 'gzopen');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzdopen, 'gzdopen');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzsetparams, 'gzsetparams');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzread, 'gzread');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzwrite, 'gzwrite');
  //  ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzprintf, 'gzprintf');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzputs, 'gzputs');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzgets, 'gzgets');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzputc, 'gzputc');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzgetc, 'gzgetc');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzflush, 'gzflush');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzseek, 'gzseek');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzrewind, 'gzrewind');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gztell, 'gztell');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzeof, 'gzeof');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzclose, 'gzclose');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} gzerror, 'gzerror');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} adler32, 'adler32');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} crc32, 'crc32');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateInit_, 'deflateInit_');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateInit_, 'inflateInit_');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} deflateInit2_, 'deflateInit2_');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateInit2_, 'inflateInit2_');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} zErrorpchar, 'zError');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} inflateSyncPoint, 'inflateSyncPoint');
    ZLibrary.SetSymbol({$ifndef FPC}@{$endif} get_crc_table, 'get_crc_table');
  end;
