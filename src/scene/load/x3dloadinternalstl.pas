...
function LoadSTL(const Stream: TStream; const BaseUrl: String;
...
begin
  if (SaveOptions <> nil) and (SaveOptions.Generator <> '') then
    HeaderStr := 'Binary STL generated by ' + SaveOptions.Generator
  else
    HeaderStr := 'Binary STL generated by Castle Game Engine';
