...
typedef void (__cdecl *PFNRD_CGE_SetUserInterfaceInfo)(bool automaticTouchInterface, int nDpi);
...
//-----------------------------------------------------------------------------
void CGE_SetUserInterfaceInfo(bool automaticTouchInterface, int nDpi)
{
