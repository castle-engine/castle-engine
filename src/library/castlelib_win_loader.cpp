/*
  ...
  2. Copy castlelib.dll to your Debug and Release folders
...
void CGE_LoadLibrary()
{
	...
	pfrd_CGE_LoadSceneFromFile = (PFNRD_CGE_LoadSceneFromFile)GetProcAddress(g_hCgeDll, "CGE_LoadSceneFile");
