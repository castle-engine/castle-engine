...
//-----------------------------------------------------------------------------
extern void CGE_Open(unsigned uiFlags, unsigned initialWidth, unsigned initialHeight);     // init the library, this function must be called first (required). Flags is any combination of ECgeOpenFlag
