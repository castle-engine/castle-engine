...
%FPC_EXE_DIR%fpc.exe -fPIC -dRELEASE @castle-fpc.cfg -dCASTLE_WINDOW_LIBRARY src/deprecated_library/castleengine.lpr -Pi386 -FEsrc/deprecated_library/%OUT_DIR% %FPC_CONFIG%
