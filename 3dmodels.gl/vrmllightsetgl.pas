...
{ @abstract(This unit renders VRML lights list 
  (TDynActiveLightArray object from  VRMLNodes unit) into OpenGL.)
  
  It is mainly used by VRMLOpenGLRenderer 
  (to render lights while rendering whole VRML graph) but it can
  also be used separately : e.g. lets_take_a_walk has a file
