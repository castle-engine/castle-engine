...
{ VorbisDecoder_ callbacks code based on Noeska code from
  ...
  I made my own VorbisFile header, and later realized that actually
  ...
  about FPC or any OS that isn't Windows. Besides, my VorbisFile will not
  cause exception at initialization if vorbisfile will not be installled ---
  this is crucial for me. So I will continue using my own VorbisFile unit. }
