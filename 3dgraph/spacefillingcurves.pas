...
type
  ...
  protected
    procedure GeneratePixels(Pixels:PArray_Vector2Cardinal); virtual; abstract;
  public    
  ...
  protected    
    procedure GeneratePixels(Pixels:PArray_Vector2Cardinal); override;
  public  
...
procedure TSwapScanCurve.GeneratePixels(Pixels:PArray_Vector2Cardinal);
var NextPixelToWriteNum:Cardinal;

  procedure AppendPixel(x,y:Cardinal);
  begin
   Pixels[NextPixelToWriteNum,0]:=x;
   Pixels[NextPixelToWriteNum,1]:=y;
...
procedure THilbertCurve.GeneratePixels(Pixels:PArray_Vector2Cardinal);
...
begin
 ...
 InitStepData(StepData, Pixels, SizeX, SizeY);
 HilbertCurve(true, 0, Level, HilbertPeanoStep, @StepData); 
end;
...
procedure TPeanoCurve.GeneratePixels(Pixels:PArray_Vector2Cardinal);
var StepData:TStepData;
...
begin
 ...
 InitStepData(StepData, Pixels, SizeX, SizeY);
 PeanoCurve(false, 0, Level, HilbertPeanoStep, @StepData);
end;
