...
initialization
 ...
 begin
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_access_version_number) := PngLibrary.Symbol('png_access_version_number');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sig_bytes) := PngLibrary.Symbol('png_set_sig_bytes');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_sig_cmp) := PngLibrary.Symbol('png_sig_cmp');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_check_sig) := PngLibrary.Symbol('png_check_sig');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_create_read_struct) := PngLibrary.Symbol('png_create_read_struct');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_create_write_struct) := PngLibrary.Symbol('png_create_write_struct');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_compression_buffer_size) := PngLibrary.Symbol('png_get_compression_buffer_size');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_compression_buffer_size) := PngLibrary.Symbol('png_set_compression_buffer_size');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_reset_zstream) := PngLibrary.Symbol('png_reset_zstream');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_chunk) := PngLibrary.Symbol('png_write_chunk');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_chunk_start) := PngLibrary.Symbol('png_write_chunk_start');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_chunk_data) := PngLibrary.Symbol('png_write_chunk_data');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_chunk_end) := PngLibrary.Symbol('png_write_chunk_end');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_create_info_struct) := PngLibrary.Symbol('png_create_info_struct');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_info_init) := PngLibrary.Symbol('png_info_init');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_info_before_PLTE) := PngLibrary.Symbol('png_write_info_before_PLTE');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_info) := PngLibrary.Symbol('png_write_info');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_info) := PngLibrary.Symbol('png_read_info');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_convert_to_rfc1123) := PngLibrary.Symbol('png_convert_to_rfc1123');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_convert_from_struct_tm) := PngLibrary.Symbol('png_convert_from_struct_tm');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_convert_from_time_t) := PngLibrary.Symbol('png_convert_from_time_t');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_expand) := PngLibrary.Symbol('png_set_expand');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_gray_1_2_4_to_8) := PngLibrary.Symbol('png_set_gray_1_2_4_to_8');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_palette_to_rgb) := PngLibrary.Symbol('png_set_palette_to_rgb');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_tRNS_to_alpha) := PngLibrary.Symbol('png_set_tRNS_to_alpha');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_bgr) := PngLibrary.Symbol('png_set_bgr');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_gray_to_rgb) := PngLibrary.Symbol('png_set_gray_to_rgb');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_rgb_to_gray) := PngLibrary.Symbol('png_set_rgb_to_gray');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_rgb_to_gray_fixed) := PngLibrary.Symbol('png_set_rgb_to_gray_fixed');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_rgb_to_gray_status) := PngLibrary.Symbol('png_get_rgb_to_gray_status');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_build_grayscale_palette) := PngLibrary.Symbol('png_build_grayscale_palette');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_strip_alpha) := PngLibrary.Symbol('png_set_strip_alpha');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_swap_alpha) := PngLibrary.Symbol('png_set_swap_alpha');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_invert_alpha) := PngLibrary.Symbol('png_set_invert_alpha');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_filler) := PngLibrary.Symbol('png_set_filler');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_swap) := PngLibrary.Symbol('png_set_swap');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_packing) := PngLibrary.Symbol('png_set_packing');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_packswap) := PngLibrary.Symbol('png_set_packswap');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_shift) := PngLibrary.Symbol('png_set_shift');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_interlace_handling) := PngLibrary.Symbol('png_set_interlace_handling');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_invert_mono) := PngLibrary.Symbol('png_set_invert_mono');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_background) := PngLibrary.Symbol('png_set_background');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_strip_16) := PngLibrary.Symbol('png_set_strip_16');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_dither) := PngLibrary.Symbol('png_set_dither');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_gamma) := PngLibrary.Symbol('png_set_gamma');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_permit_empty_plte) := PngLibrary.Symbol('png_permit_empty_plte');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_flush) := PngLibrary.Symbol('png_set_flush');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_flush) := PngLibrary.Symbol('png_write_flush');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_start_read_image) := PngLibrary.Symbol('png_start_read_image');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_update_info) := PngLibrary.Symbol('png_read_update_info');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_rows) := PngLibrary.Symbol('png_read_rows');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_row) := PngLibrary.Symbol('png_read_row');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_image) := PngLibrary.Symbol('png_read_image');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_row) := PngLibrary.Symbol('png_write_row');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_rows) := PngLibrary.Symbol('png_write_rows');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_image) := PngLibrary.Symbol('png_write_image');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_end) := PngLibrary.Symbol('png_write_end');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_end) := PngLibrary.Symbol('png_read_end');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_destroy_info_struct) := PngLibrary.Symbol('png_destroy_info_struct');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_destroy_read_struct) := PngLibrary.Symbol('png_destroy_read_struct');
// {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_destroy) := PngLibrary.Symbol('png_read_destroy');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_destroy_write_struct) := PngLibrary.Symbol('png_destroy_write_struct');
// {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_destroy_info) := PngLibrary.Symbol('png_write_destroy_info');
// {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_destroy) := PngLibrary.Symbol('png_write_destroy');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_crc_action) := PngLibrary.Symbol('png_set_crc_action');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_filter) := PngLibrary.Symbol('png_set_filter');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_filter_heuristics) := PngLibrary.Symbol('png_set_filter_heuristics');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_compression_level) := PngLibrary.Symbol('png_set_compression_level');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_compression_mem_level) := PngLibrary.Symbol('png_set_compression_mem_level');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_compression_strategy) := PngLibrary.Symbol('png_set_compression_strategy');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_compression_window_bits) := PngLibrary.Symbol('png_set_compression_window_bits');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_compression_method) := PngLibrary.Symbol('png_set_compression_method');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_init_io) := PngLibrary.Symbol('png_init_io');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_error_fn) := PngLibrary.Symbol('png_set_error_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_error_ptr) := PngLibrary.Symbol('png_get_error_ptr');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_write_fn) := PngLibrary.Symbol('png_set_write_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_read_fn) := PngLibrary.Symbol('png_set_read_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_io_ptr) := PngLibrary.Symbol('png_get_io_ptr');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_read_status_fn) := PngLibrary.Symbol('png_set_read_status_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_write_status_fn) := PngLibrary.Symbol('png_set_write_status_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_read_user_transform_fn) := PngLibrary.Symbol('png_set_read_user_transform_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_write_user_transform_fn) := PngLibrary.Symbol('png_set_write_user_transform_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_user_transform_info) := PngLibrary.Symbol('png_set_user_transform_info');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_user_transform_ptr) := PngLibrary.Symbol('png_get_user_transform_ptr');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_read_user_chunk_fn) := PngLibrary.Symbol('png_set_read_user_chunk_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_user_chunk_ptr) := PngLibrary.Symbol('png_get_user_chunk_ptr');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_progressive_read_fn) := PngLibrary.Symbol('png_set_progressive_read_fn');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_progressive_ptr) := PngLibrary.Symbol('png_get_progressive_ptr');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_process_data) := PngLibrary.Symbol('png_process_data');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_progressive_combine_row) := PngLibrary.Symbol('png_progressive_combine_row');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_malloc) := PngLibrary.Symbol('png_malloc');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_free) := PngLibrary.Symbol('png_free');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_free_data) := PngLibrary.Symbol('png_free_data');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_data_freer) := PngLibrary.Symbol('png_data_freer');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_memcpy_check) := PngLibrary.Symbol('png_memcpy_check');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_memset_check) := PngLibrary.Symbol('png_memset_check');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_error) := PngLibrary.Symbol('png_error');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_chunk_error) := PngLibrary.Symbol('png_chunk_error');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_warning) := PngLibrary.Symbol('png_warning');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_chunk_warning) := PngLibrary.Symbol('png_chunk_warning');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_valid) := PngLibrary.Symbol('png_get_valid');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_rowbytes) := PngLibrary.Symbol('png_get_rowbytes');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_rows) := PngLibrary.Symbol('png_get_rows');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_rows) := PngLibrary.Symbol('png_set_rows');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_channels) := PngLibrary.Symbol('png_get_channels');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_image_width) := PngLibrary.Symbol('png_get_image_width');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_image_height) := PngLibrary.Symbol('png_get_image_height');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_bit_depth) := PngLibrary.Symbol('png_get_bit_depth');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_color_type) := PngLibrary.Symbol('png_get_color_type');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_filter_type) := PngLibrary.Symbol('png_get_filter_type');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_interlace_type) := PngLibrary.Symbol('png_get_interlace_type');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_compression_type) := PngLibrary.Symbol('png_get_compression_type');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_pixels_per_meter) := PngLibrary.Symbol('png_get_pixels_per_meter');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_x_pixels_per_meter) := PngLibrary.Symbol('png_get_x_pixels_per_meter');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_y_pixels_per_meter) := PngLibrary.Symbol('png_get_y_pixels_per_meter');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_pixel_aspect_ratio) := PngLibrary.Symbol('png_get_pixel_aspect_ratio');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_x_offset_pixels) := PngLibrary.Symbol('png_get_x_offset_pixels');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_y_offset_pixels) := PngLibrary.Symbol('png_get_y_offset_pixels');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_x_offset_microns) := PngLibrary.Symbol('png_get_x_offset_microns');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_y_offset_microns) := PngLibrary.Symbol('png_get_y_offset_microns');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_signature) := PngLibrary.Symbol('png_get_signature');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_bKGD) := PngLibrary.Symbol('png_get_bKGD');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_bKGD) := PngLibrary.Symbol('png_set_bKGD');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_cHRM) := PngLibrary.Symbol('png_get_cHRM');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_cHRM_fixed) := PngLibrary.Symbol('png_get_cHRM_fixed');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_cHRM) := PngLibrary.Symbol('png_set_cHRM');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_cHRM_fixed) := PngLibrary.Symbol('png_set_cHRM_fixed');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_gAMA) := PngLibrary.Symbol('png_get_gAMA');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_gAMA_fixed) := PngLibrary.Symbol('png_get_gAMA_fixed');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_gAMA) := PngLibrary.Symbol('png_set_gAMA');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_gAMA_fixed) := PngLibrary.Symbol('png_set_gAMA_fixed');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_hIST) := PngLibrary.Symbol('png_get_hIST');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_hIST) := PngLibrary.Symbol('png_set_hIST');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_IHDR) := PngLibrary.Symbol('png_get_IHDR');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_IHDR) := PngLibrary.Symbol('png_set_IHDR');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_oFFs) := PngLibrary.Symbol('png_get_oFFs');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_oFFs) := PngLibrary.Symbol('png_set_oFFs');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_pCAL) := PngLibrary.Symbol('png_get_pCAL');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_pCAL) := PngLibrary.Symbol('png_set_pCAL');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_pHYs) := PngLibrary.Symbol('png_get_pHYs');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_pHYs) := PngLibrary.Symbol('png_set_pHYs');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_PLTE) := PngLibrary.Symbol('png_get_PLTE');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_PLTE) := PngLibrary.Symbol('png_set_PLTE');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_sBIT) := PngLibrary.Symbol('png_get_sBIT');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sBIT) := PngLibrary.Symbol('png_set_sBIT');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_sRGB) := PngLibrary.Symbol('png_get_sRGB');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sRGB) := PngLibrary.Symbol('png_set_sRGB');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sRGB_gAMA_and_cHRM) := PngLibrary.Symbol('png_set_sRGB_gAMA_and_cHRM');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_iCCP) := PngLibrary.Symbol('png_get_iCCP');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_iCCP) := PngLibrary.Symbol('png_set_iCCP');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_sPLT) := PngLibrary.Symbol('png_get_sPLT');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sPLT) := PngLibrary.Symbol('png_set_sPLT');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_text) := PngLibrary.Symbol('png_get_text');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_text) := PngLibrary.Symbol('png_set_text');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_tIME) := PngLibrary.Symbol('png_get_tIME');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_tIME) := PngLibrary.Symbol('png_set_tIME');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_tRNS) := PngLibrary.Symbol('png_get_tRNS');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_tRNS) := PngLibrary.Symbol('png_set_tRNS');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_sCAL) := PngLibrary.Symbol('png_get_sCAL');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sCAL) := PngLibrary.Symbol('png_set_sCAL');
// {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_sCAL_s) := PngLibrary.Symbol('png_set_sCAL_s');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_keep_unknown_chunks) := PngLibrary.Symbol('png_set_keep_unknown_chunks');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_unknown_chunks) := PngLibrary.Symbol('png_set_unknown_chunks');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_unknown_chunk_location) := PngLibrary.Symbol('png_set_unknown_chunk_location');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_unknown_chunks) := PngLibrary.Symbol('png_get_unknown_chunks');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_set_invalid) := PngLibrary.Symbol('png_set_invalid');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_read_png) := PngLibrary.Symbol('png_read_png');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_write_png) := PngLibrary.Symbol('png_write_png');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_header_ver) := PngLibrary.Symbol('png_get_header_ver');
  {$ifdef FPC_OBJFPC} Pointer {$else} @ {$endif} (png_get_header_version) := PngLibrary.Symbol('png_get_header_version');
 end;
finalization
