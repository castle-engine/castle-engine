...
/* CGE: rename to mergesort_ogg */
static void mergesort_ogg(char *index,ogg_uint16_t *vals,ogg_uint16_t n){
  ogg_uint16_t i,j;
...
vorbis_info_floor *floor1_info_unpack (vorbis_info *vi,oggpack_buffer *opb){
  ...
  mergesort_ogg(info->forward_index,info->postlist,info->posts);
