...
begin
  ...
  try
    ...
    case Target of
      targetAndroid:
        begin
          CompileAndroid(Compiler, Self, Mode, Path, AndroidSourceFile(true, true),
            SearchPaths, LibraryPaths, ExtraOptions);
        end;
      targetIOS:
        begin
          CompileIOS(Compiler, Mode, Path, IOSSourceFile(true, true),
            SearchPaths, LibraryPaths, ExtraOptions);
          LinkIOSLibrary(Compiler, Path, IOSLibraryFile);
      ...
      targetCustom:
        begin
          case OS of
            Android:
              begin
                Compile(Compiler, OS, CPU, Plugin, Mode, Path, AndroidSourceFile(true, true),
                  SearchPaths, LibraryPaths, ExtraOptions);
              ...
              begin
                ...
                Compile(Compiler, OS, CPU, Plugin, Mode, Path, MainSource,
                  SearchPaths, LibraryPaths, ExtraOptions);
...
function TCastleProject.Compiler: TCompiler;
begin
