...
type
  ...
  public
    ...
    { Create CastleAutoGenerated unit in the main project directory. }
    procedure MakeCastleAutoGeneratedUnit;
  end;
            ...
            Android:
              ...
              begin
                ...
                if MakeAutoGeneratedResources(Self, Path + ExtractFilePath(MainSource), OS, CPU) then
                  CompilerOptions.Defines.Add('CASTLE_AUTO_GENERATED_RESOURCES');

                if Target = targetMacOS then
                  CompileMacOS(FinalCompiler, Path, MainSource, CompilerOptions)
                else
...
procedure TCastleProject.MakeCastleAutoGeneratedUnit;
var
  TemplateFile, OutputFile, OutputFileRelative: String;
begin
  OutputFile := Path + 'castleautogenerated.pas';
  OutputFileRelative := 'castleautogenerated.pas';
  TemplateFile := UriToFilenameSafe('castle-data:/castleautogenerated_template.pas');
  ExtractTemplateFile(TemplateFile, OutputFile, OutputFileRelative, true);
end;
