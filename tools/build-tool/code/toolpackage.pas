...
uses CastleUtils, CastleInternalAutoGenerated, CastleInternalArchitectures,
  ToolPackageFormat, ToolManifest;

type
  { Package a project (from a given directory) to a number of formats.
    This supports the cross-platform formats from TPackageFormatNoDefault
    (which means: most, but not all, TPackageFormatNoDefault values . }
