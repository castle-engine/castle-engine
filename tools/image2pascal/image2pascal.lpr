...
begin
  case OptionNum of
    0: begin
        Writeln(
          'image2pascal: Convert image files into Pascal source code,' +NL+
          'useful together with Castle Game Engine image units.' +NL+
          nl+
          'Call like' +NL+
          '  image2pascal [OPTIONS...] UnitName image_name1.png...' +NL+
          nl+
...
begin
  ...
  OutputUnit.Write(
    ...
    nl+
    '{ Unit automatically generated by image2pascal tool,' +NL+
