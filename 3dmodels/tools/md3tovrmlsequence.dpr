...
{ Convert MD3 model to a sequence of VRML models.
  This way we convert MD3 animation to a simple animation that consists
  of many VRML files and may be played by our demo_animation program
  (see kambi_vrml_game_engine/3dmodels.gl/examples/).
