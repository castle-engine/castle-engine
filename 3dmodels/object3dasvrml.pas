...
var
  ...
  begin
    ...
    { First iterate to gather all transformations.
      ...
      but for Collada 1.3 (at least for files generated by Blender
      Collada 1.3 exporter, I didn't look in Collada 1.3 spec ?)
      this is needed: we have <instantiate> first, then
      <matrix>, and yes: matrix should affect instantiated object. }
